...
// File: contracts/DrippedCamels.sol
...
contract DrippedCamels is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard {
  uint public constant teamReserveAmount       = 0;
  
  uint public          totalAvailable          = 3333;
  uint public          maxPerTx                = 5;
  uint public          maxPerAddressDuringMint = 100;
