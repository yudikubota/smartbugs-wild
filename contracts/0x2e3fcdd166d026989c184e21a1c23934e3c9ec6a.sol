...
contract EVEN_DEAD_IM_THE_HERO is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"EVEN_DEAD_IM_THE_HERO"; ////
    string public constant symbol = unicode"E.D.I.T.H"; ////
