...
contract TenThousandX is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 8_000_000 * 10**_decimals;
    string private constant _name = "10000X";
    string private constant _symbol = "10000X";
    uint256 public _maxTxAmount = 20_000 * 10**_decimals;
    uint256 public _maxWalletSize = 20_000 * 10**_decimals;
    uint256 public _taxSwap=42_000 * 10**_decimals;
