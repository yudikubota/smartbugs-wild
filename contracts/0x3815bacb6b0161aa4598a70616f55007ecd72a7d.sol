{{
  "language": "Solidity",
  "sources": {
    "contracts/minters/SagaHistoricMinter.sol": {
...
contract SagaHistoricMinter is Ownable, MixinPausable {
  ...
  // }
    ...
    "contracts/library/LibSafeMath.sol": {
      "content": "pragma solidity ^0.7.0;
...
contract HashRegistry is Ownable {
  ...
  function writeToRegistry(uint256[] memory tokenIds, uint256[] memory txHashes) public onlyIfPermissed(msg.sender) {
    ...
    "contracts/library/LibRichErrors.sol": {
      "content": "pragma solidity ^0.7.0;
...
library LibRichErrors {
    ...
    "contracts/library/LibSafeMathRichErrors.sol": {
      "content": "pragma solidity ^0.7.0;
...
library LibSafeMathRichErrors {
    ...
    "contracts/library/LibAddress.sol": {
      "content": "pragma solidity ^0.7.0;
