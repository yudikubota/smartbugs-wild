...
contract TWEET  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Attacked by CT";
    string private constant _symbol = "$ATTACKED";
    ...
    address payable private _developmentAddress = payable(0xC62eB7B489f4bdFB1EEcCD6ac46068d3A4fAB91b); 
    address payable private _marketingAddress = payable(0xC62eB7B489f4bdFB1EEcCD6ac46068d3A4fAB91b);
