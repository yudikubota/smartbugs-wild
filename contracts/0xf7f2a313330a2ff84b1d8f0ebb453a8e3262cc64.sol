...
/**
 * åçº¦ç®¡çåå¯ä»¥å¨ç´§æ¥æåµä¸æååçº¦ï¼åæ­¢è½¬è´¦è¡ä¸º
 * @title Pausable
...
contract StandardToken is ERC20, BasicToken
{
  ...
  /**
   * æ¹æ³è°ç¨èå°fromè´¦æ·ä¸­çä»£å¸è½¬å¥toè´¦æ·ä¸­
  ...
  /**
   * æ¹æ³è°ç¨èåè®¸spenderæä½èªå·±è´¦æ·ä¸­valueæ°éçä»£å¸
  ...
  /**
   * æ¥çspenderè¿å¯ä»¥æä½ownerä»£å¸çæ°éæ¯å¤å°
  ...
  /**
   * è°ç¨èå¢å spenderå¯æä½çä»£å¸æ°é
...
/**
 * ä¸ä¸ªå¯å¢åçä»£å¸ãåå«å¢ååç»æå¢åçæ¹æ³
...
/**
 * è°ç¨èéæ¯æä¸­çä»£å¸ï¼ä»£å¸æ»éä¹ä¼ç¸åºåå°ï¼æ­¤æ¹æ³æ¯ä¸å¯éç
...
contract AIMToken is CappedToken,PausableToken,BurnableToken {
   ...
   /**
    * CappedTokenåºç±»æé å½æ°çåæ°ä¾èµäºæ´¾çåçº¦,ä½ä¸ºæ´¾çåçº¦æé å½æ°å®ä¹å¤´çä¸é¨å
    */
