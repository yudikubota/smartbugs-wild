...
contract Comptroller is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function exitMarket(address gTokenAddress) external returns (uint) {
        ...
        /* Delete gToken from the accountâs list of assets */
...
"},"ComptrollerProxy.sol":{"content":"pragma solidity ^0.5.16;
...
"},"GToken.sol":{"content":"pragma solidity ^0.5.16;
...
"},"GTokenInterfaces.sol":{"content":"pragma solidity ^0.5.16;
