...
contract LedToken is CustomToken {
    uint8 private DECIMALS = 4; // ììì  ìë¦¬ì
    uint256 private MAX_TOKEN_COUNT = 1000000000; // ì´ í í° ê°ì
    uint256 private MAX_SUPPLY = MAX_TOKEN_COUNT * (10**uint256(DECIMALS)); // ì´ ë°íë
    uint256 private INITIAL_SUPPLY = (MAX_SUPPLY * 1) / 1; // ì´ê¸° ê³µê¸ë
    string private TOKEN_NAME = "Ledgis"; // í í° ì´ë¦
    string private TOKEN_SYMBOL = "LED"; // í í° ì¬ë³¼
