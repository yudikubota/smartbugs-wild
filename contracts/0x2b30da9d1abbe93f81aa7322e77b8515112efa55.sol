...
JEWSRAEL - WITH JEWS YOU WIN

Can all the goyim please leave the room? Yes, that means you. Lock your metamask (or maybe not) and walk away from the computer. We'll let you know when it's safe to return.

Don't let the goyim in, this is our secret plan to take over crypto. The only way to send $JEW to heaven is controlling the supply, join the ranks!

Website: https://jewsrael.lol
Telegram: https://t.me/jewsraelportal
Twitter: https://twitter.com/Jewsrael_lol
...
contract JEWSRAEL is IERC20, Ownable {
    ...
    uint8 public _marketingTax = 60;
    uint8 public _GoyimTax = 20;
