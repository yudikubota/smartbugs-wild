...
/* 
    ...
    FINALLY has the best utility in the space nowdays. Itâs not a rug, this is the use case.
    ...
    Serial scammers. F U!
    Hyped launches with whitelisted influencer shits â FUCK YOU!
    Insidoor random pumps, then dumping on us â FUCK YOU!  
    Trash copperlaunches and mf larp coins? â Enough, thank you.  
    ...
    Nothing to ape in this shitty market? I feel the same. Letâs discuss what this token would be. 

    How much tax do you want? What should be the max buy?
    Send ethscan message, Iâm down for everything. We figure it out, I launch this shit,
    lock the LP for 1 week intially and extend on certain MC.
    7 days jeet lock ?
    In the beginning yes. Market is jeety. If we show that this is not a jeet coin, Iâm extending. 

    No, donât have TG yet. Letâs do it and invite me, send link on ethscan. Iâll join anon, like one of you. 

    Noodles was right, the whole market infected now. (https://t.me/Noodles_calls/1801)
    Try to make together some funny and good-mood launch. You own the project, own the socials, Iâm just a useless tool, who launching. 

    Bring your best memes, GIFs, positivity and fuckinâ ape the only coin which not rug today.

    FINALLY this will be different â everything is up to you.
*/
