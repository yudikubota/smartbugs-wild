{{
  "language": "Solidity",
  "sources": {
    "src/MaethstroEthRadioTip.sol": {
      "content": "pragma solidity ^0.8.13;

import {ERC20} from "openzeppelin-contracts/contracts/token/ERC20/ERC20.sol";

/// @title MAÎTHSTRO Ethereum Radio Tip Contract
/// @author MAÎTHSTRO
/// @notice Handles tips and donations for the MAÎTHSTRO Ethereum Radio.
...
contract MaethstroEthRadioTip {
    /// Address of the MAÎTHSTRO team
    ...
    /// @notice Donate eth and send a message to the MAÎTHSTRO Ethereum Radio
