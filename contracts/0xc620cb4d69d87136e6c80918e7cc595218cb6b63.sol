...
contract YFswap is BurnableToken, MintableToken, WhitelistedPausableToken, DetailedERC20 {
    ...
    constructor() DetailedERC20("YFswap", "YFS", 18) public {
        owner = msg.sender;
        mint(owner, 70000*10**18);
    }
