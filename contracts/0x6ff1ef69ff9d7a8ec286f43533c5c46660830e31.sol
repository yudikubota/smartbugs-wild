/**
   ...
   #cEso The New Community Eso Token
    
   Time: 7:13 AM Saturday, Seprember 3, 2022, UTC.
   #ESO was rugged, and hundreds of investors in crypto got hurt.
   Tx: https://etherscan.io/tx/0x6246584c0880a10a11fb6fb68c018125965109c9d0c7efa496b71ad59e648634

   I make this #cEso to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunityEso

   Great features:
   3% fee auto add to the liquidity pool. (I want to make it 0/0 but I don't want you to lose ETH from MEV Bots)
   No marketing Tax

   I will renounce the ownership to burn addresses to transfer #cEso to the community and ensure it's 100% safe.

   Can you make #cEso 10000000X? 
   No Team Tokens
...
contract cEso is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "New Community Eso";
    string private constant tokenSymbol = "cEso";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x7d465986bfED273d87A62505Ce0cA5eACbb04da1);
        devAddress = payable(0x7d465986bfED273d87A62505Ce0cA5eACbb04da1);

        liquidityAddress = payable(0x7d465986bfED273d87A62505Ce0cA5eACbb04da1);
    ...
    function GoLive() external onlyOwner returns (bool){
        ...
        launchSetLiquidityAddress(devAddress);
        maxWalletOn = true;
