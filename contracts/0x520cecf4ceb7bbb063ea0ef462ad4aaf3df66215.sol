{"Address.sol":{"content":"pragma solidity ^0.7.0;
...
}"},"Hotties.sol":{"content":"// SPDX-License-Identifier: No License
...
}"},"IHotties.sol":{"content":"import "./IERC721Enumerable.sol";

interface IHotties is IERC721Enumerable {
    function isMintedBeforeReveal(uint256 index) external view returns (bool);
}"},"LoveYourHottie.sol":{"content":"pragma solidity ^0.7.0;
...
}"},"Stringstrings.sol":{"content":"pragma solidity ^0.7.0;
