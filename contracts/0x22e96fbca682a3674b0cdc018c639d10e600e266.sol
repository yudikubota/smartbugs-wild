{{
  "language": "Solidity",
  "sources": {
    "contracts/lina_swap/sls_swap.sol": {
...
contract SLSSwap is Ownable, ReentrancyGuard {
    ...
    "contracts/lina_swap/interfaces/IERC20.sol": {
      "content": "//SPDX-License-Identifier: UNLICENSED
...
interface IERC20 {
    ...
    "contracts/lina_swap/ownership/Ownable.sol": {
      "content": "//SPDX-License-Identifier: UNLICENSED
...
contract Ownable {
  ...
  function transferOwnership(address _newOwner) external onlyOwner {
    ...
    "contracts/lina_swap/lifecycle/ReentrancyGuard.sol": {
...
"
    ...
    "contracts/lina_swap/utils/SafeMath.sol": {
      "content": "// SPDX-License-Identifier: MIT
