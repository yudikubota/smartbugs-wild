{{
  ...
  "sources": {
    "contracts/arteQArtDrop.sol": {
      "content": "/*
 * This file is part of the contracts written for art̬Q Investment Fund (https://arteq.io).
 *
...
"
    ...
    "contracts/ERC721URIStorage.sol": {
      "content": "/*
 * This file is part of the contracts written for art̬Q Investment Fund (https://github.com/billionbuild/arteq-contracts).
...
/// @title The interface for finalizing tasks. Mainly used by art̬Q contracts to
