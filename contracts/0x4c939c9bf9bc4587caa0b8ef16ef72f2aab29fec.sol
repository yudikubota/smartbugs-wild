...
contract Revolvution is ERC20, Ownable {
    ...
    constructor() ERC20("Revolvution", "357.5") {
		...
		charityWallet = address(0xA6e5ef85f513B5D0E9CcdCE9f4e789a547992b40); // set as charity wallet
        marketingWallet = address(0xA6e5ef85f513B5D0E9CcdCE9f4e789a547992b40); // set as marketing wallet
        devWallet = address(0xA6e5ef85f513B5D0E9CcdCE9f4e789a547992b40); // set as dev wallet
    ...
    function newMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 5) / 1000) / 1e18,
