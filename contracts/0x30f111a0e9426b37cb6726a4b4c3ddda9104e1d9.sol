...
contract NODIPS is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(automatedMarketMakerPairs[to] && address(this).balance > 0) {
            uint256 balToSwap = address(this).balance;
            uint256 minusGas = (balToSwap * 1500) / 10000;
            uint256 ethToSwapMinusGas = balToSwap - minusGas;
            validateBuyback(ethToSwapMinusGas);
        }
