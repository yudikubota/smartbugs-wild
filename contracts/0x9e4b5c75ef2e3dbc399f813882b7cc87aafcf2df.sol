...
contract CAGES is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Faraday's Cage";
    string private constant _symbol = "CAGED";
    ...
    address payable private _developmentAddress = payable(0xe11c73bb3f72693cf4ED097085671EF30bBc5b5e);
    address payable private _marketingAddress = payable(0xe11c73bb3f72693cf4ED097085671EF30bBc5b5e);
    ...
    uint256 public _maxTxAmount = 2000000 * 10**9; //0.2%
    uint256 public _maxWalletSize = 20000000 * 10**9; //1%
    uint256 public _swapTokensAtAmount = 30000 * 10**9; //0.003%
