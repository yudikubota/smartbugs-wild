// The software and documentation available in this repository (the "Software") is protected by copyright law and accessible pursuant to the license set forth below. Copyright Â© 2020 MRTB Ltd. All rights reserved.
//
// Permission is hereby granted, free of charge, to any person or organization obtaining the Software (the âLicenseeâ) to privately study, review, and analyze the Software. Licensee shall not use the Software for any other purpose. Licensee shall not modify, transfer, assign, share, or sub-license the Software or any derivative works of the Software.
//
...
library LibEIP712 {
    ...
    function hashEIP712Message(bytes32 eip712hash) internal pure returns (bytes32) {
        return keccak256(abi.encodePacked("", DOMAIN_SEPARATOR, eip712hash));
    }
}
...
library LibMathSigned {
    ...
    function wln(int256 x) internal pure returns (int256) {
        ...
        // Ln(1+x) = x - --- + --- - --- + ...
        //                2     3     4
        // when -1 < x < 1, O(x^n) < Îµ => when n = 36, 0 < x < 0.316
        //
        //                    2    x           2    x          2    x
        // Ln(a+x) = Ln(a) + ---(------)^1  + ---(------)^3 + ---(------)^5 + ...
...
library LibOrder {
    ...
    struct Order {
         ...
         * â                    â length(bytes)   desc                                      â
         * ââââââââââââââââââââââ¼ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ¢
         * â version            â 1               order version                             â
         * â side               â 1               0: buy (long), 1: sell (short)            â
         * â isMarketOrder      â 1               0: limitOrder, 1: marketOrder             â
         * â expiredAt          â 5               order expiration time in seconds          â
         * â asMakerFeeRate     â 2               maker fee rate (base 100,000)             â
         * â asTakerFeeRate     â 2               taker fee rate (base 100,000)             â
         * â (d) makerRebateRateâ 2               rebate rate for maker (base 100)          â
         * â salt               â 8               salt                                      â
         * â isMakerOnly        â 1               is maker only                             â
         * â isInversed         â 1               is inversed contract                      â
         * â chainId            â 8               chain id                                  â
         * ââââââââââââââââââââââ§ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
         */
        bytes32 data;
    }
