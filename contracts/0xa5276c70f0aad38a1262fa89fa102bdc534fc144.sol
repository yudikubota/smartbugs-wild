...
? As a sneak peak, here are the basic features of how the contract will be:
        â a) 5,000,000,000,000 Total Omusubi
        â b) 100% added to Uniswap as Liquidity (No shitty presale or dev tokens)
        â c) 15,000,000,000 limit max buy limit + 45sec cooldown between buys for only the FIRST TWO MINUTES, which is lifted automatically. There will be a 15sec cooldown after a buy to nuke the frontrunning bots. (post two minutes there won't be buy/sell limits)
        â d) 10% total tax on buy
             1) 6% Tax for Redistribution to Hodlers as rewards
             2) 2% Tax for Buyback
             3) 2% Tax Marketing
        â e) There will be a dynamic fee based on the price impact, ranging from 10% to 40% fee with NO time restrictive sell limits (unlike MyÅbu).
