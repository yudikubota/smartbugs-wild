...
}"},"DOKI.SOL":{"content":"pragma solidity ^0.8.4;
...
contract OkidokiSocial is RewardsToken {
    ...
    address payable private _platformWalletAddress =
        payable(0x2FFef3ff3f53EA177be6f40c701cfd79d79B90Ea);
    address payable private _devWalletAddress =
        payable(0x5e8a57536510C3c9635F6d940d0Ffa42E2F83995);
    ...
    constructor() ERC20("Okidoki Social", "DOKI") {
    ...
    function prepareForLaunch() external onlyOwner {
        ...
        launchSellFeeDeadline = block.timestamp + 4 days;
    }
