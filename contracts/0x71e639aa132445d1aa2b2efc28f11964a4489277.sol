...
contract Strategy is Ownable {
    ...
    "src/IArbVault.sol": {
      "content": "import { ERC20 } from "solmate/mixins/ERC4626.sol";
...
"
    ...
    "src/notional/NotionalProxy.sol": {
      "content": "import "./nTokenERC20.sol";
...
"
    ...
    "src/notional/nERC1155Interface.sol": {
      "content": "import "./Types.sol";
...
"
    ...
    "src/interface/IFlashLoan.sol": {
      "content": "interface IFlashLoan {
    function flashLoan(
        address recipient,
        address[] memory tokens,
        uint256[] memory amounts,
...
"
    ...
    "src/notional/NotionalGovernance.sol": {
      "content": ""
    },
    "src/notional/NotionalViews.sol": {
      "content": "// File: NotionalViews.sol
import "./Types.sol";
...
"
    ...
    "src/yieldProtocol/ICauldron.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "./IFYToken.sol";
import "./IOracle.sol";
...
"
    ...
    "lib/yield-utils-v2/contracts/token/IERC20.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
interface IERC20 {
    ...
    "src/yieldProtocol/IFYToken.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "@yield-protocol/utils-v2/contracts/token/IERC20.sol";
import "./IJoin.sol";
...
"
    ...
    "src/yieldProtocol/DataTypes.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "./IFYToken.sol";
import "./IOracle.sol";
...
"
  ...
  "settings": {
    "remappings": [
      ...
      "vault-interfaces/=lib/vault-interfaces/src/",
      "yield-utils-v2/=lib/yield-utils-v2/contracts/",
      "src/=src/"
    ],
    "optimizer": {
      "enabled": true,
