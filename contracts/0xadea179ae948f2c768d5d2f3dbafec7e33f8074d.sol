...
contract BabyGhost is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmZEEcwBpCA3GVoRkKsDg1GQB4Nn7MY5Lg9PXwqTmRSrAg/";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 44;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("Baby Ghost", "BG") {
        baseURI = initBaseURI;
