...
"
    ...
    "@adrastia-oracle/adrastia-core/contracts/accumulators/proto/uniswap/UniswapV3PriceAccumulator.sol": {
      "content": "//SPDX-License-Identifier: MIT
pragma solidity =0.8.13;
...
"
    ...
    "@adrastia-oracle/adrastia-core/contracts/libraries/uniswap-lib/FullMath.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity =0.8.13;
...
library FullMath {
    /**
     * @notice Calculates floor(aÃbÃ·denominator) with full precision. Throws if result overflows a uint256 or
     *   denominator == 0
    ...
    /**
     * @notice Calculates ceil(aÃbÃ·denominator) with full precision. Throws if result overflows a uint256 or
     *   denominator == 0
     * @param a The multiplicand
     * @param b The multiplier
     * @param denominator The divisor
...
"
    ...
    "@adrastia-oracle/adrastia-periphery/contracts/accumulators/proto/uniswap/ManagedUniswapV3PriceAccumulator.sol": {
      "content": "//SPDX-License-Identifier: MIT
pragma solidity =0.8.13;
...
"
    ...
    "contracts/accumulators/UniswapV3PA.sol": {
      "content": "//SPDX-License-Identifier: MIT
pragma solidity =0.8.13;
