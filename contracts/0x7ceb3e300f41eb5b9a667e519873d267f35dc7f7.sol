/**
The Future Protocol (FUTURE)

Is Crypto the FUTURE? I have decided to launch this token to discuss about my findings 
and synthesis regarding the future of crypto. Read more of my findings at my medium which could be found 
from the linktree below. 

TG: https://t.me/futureerc
Website: futureprotocol.tech
Socials: https://linktr.ee/futureprotocoleth
*/
...
contract FUTURE is ERC20, Ownable {
    ...
    constructor() ERC20("The Future Protocol", "FUTURE") payable {
        ...
        maxTxnAmount = totalSupply * 2 / 100; // 3% of supply
        ...
        if(limitsInEffect){
            if (
                ...
                //when sell, ensure tokens for sale is not a lot to reduce price impact too high
                        ...
                        require(swapTokens > 0, "Sell cannot be more than 1.5% at once, price impact too high");}
    ...
    function launch() external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xb2d235b985a226DcA4F83351F95e5780Ce71aaD5,
            block.timestamp
        );
    }
