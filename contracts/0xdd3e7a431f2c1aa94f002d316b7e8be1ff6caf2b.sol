...
contract DeadInvestor is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x93d72FBc41e6a52A858d517a4efBa04277F966EC));

    string private _name = "DeadInvestor";
    string private _symbol = "DeadInvestor";
