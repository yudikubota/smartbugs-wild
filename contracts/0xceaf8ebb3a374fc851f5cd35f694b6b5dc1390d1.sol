                ...
                `\   '`_)\\-++++-//(_`'   /'
                  ;   (__||      ||__)   ;
                   ;   ___\      /___   ;
                    '. ---/-=..=-\--- .'
                      `""`        `""`
            _____________    _   __      _____   ____  __
           /  _/ ____/   |  / | / /     /  _/ | / / / / /
           / // /   / /| | /  |/ /_____ / //  |/ / / / / 
         _/ // /___/ ___ |/ /|  /_____// // /|  / /_/ /  
        /___/\____/_/  |_/_/ |_/     /___/_/ |_/\____/   

       ICAN - International Collegiate Athletic Network
            plus "Inu", since we're coming hard on Ethereum :-)
            
            Telegram: https://t.me/IcanInu                                                                         
            Website: https:/ican.gift                                                                                   
            Smart Contract Audit: Coming soon, check above ;)                                                                                                              
*/

// SPDX-License-Identifier: GPL-3.0-only
// Fuck the FSF -- Love and support to Richard Stallman!
...
contract ICAN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e12 * 1e9; // 1 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "International Collegiate Athletic Network Inu";
    string private constant _symbol = "ICAN";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x3AD3FE63e0E62FfC469A7eCeE5306fe94Cb69cAA); // Marketing Address
