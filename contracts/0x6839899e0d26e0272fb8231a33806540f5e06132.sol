...
contract TNBToken is TNBTokenI {
    ...
    string public name;                //ä»£å¸åç§°: e.g. DigixDAO Tokens
    uint8 public decimals;             //æå°åä½ç²¾åº¦ï¼å³å¯ä»¥ç²¾ç¡®å°å°æ°ç¹åå¤å°ä½
    string public symbol;              //ç¬¦å·
    string public version = "TNB_0.2"; //ä»»ææ ¼å¼ççæ¬æ°æ®
    uint256 public maximumTNB = 60 * 10**8 * 10**18;
    /// @dev `Checkpoint` æ¯ä¸ä¸ªè®°å½åºåæ°åå¶å¯¹åºæ»é¢çç»æ
    struct Checkpoint {
...
////////////////
    ...
    function ()  payable {
        //å±è½æ§å¶æ¹çåçº¦ç±»åæ£æ¥ï¼ä»¥å¼å®¹åè¡æ¹æ æ§å¶åçº¦çæåµã
