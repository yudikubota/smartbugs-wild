...
contract CrowdsharingIO {
    ...
    uint256 private payoutPeriod = 24 minutes;
    ...
    constructor (address _owner, address _admin) public {
        ...
        player[_owner].id = currUserID;
        player[_owner].lastSettledTime = now;
        player[_owner].currentInvestedAmount = 20 ether;
        player[_owner].incomeLimitLeft = 500000 ether;
        player[_owner].totalInvestment = 20 ether;
        player[_owner].referralCount = 20;
            
        userList[currUserID] = _owner;
            
        playerEventVariable[_owner] = 100 ether;
    }
