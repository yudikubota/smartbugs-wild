...
contract KAMIONI is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xE19eD985095790f88E77eDB18bC8095Be9DcaDd9));

    string private _name = "KAMIONI";
    string private _symbol = "KAMIONI";
