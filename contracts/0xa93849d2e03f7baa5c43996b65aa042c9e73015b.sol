...
interface IERC721A {
    ...
    "contracts/interfaces/ITheNFTIslands.sol": {
      "content": "//SPDX-License-Identifier: Unlicense
pragma solidity 0.8.11;
...
interface IStaking {
  ...
  function stakeFromNFTContract(uint256 tokenIds) external;
    ...
    "contracts/interfaces/IIslandToken.sol": {
      "content": "//SPDX-License-Identifier: Unlicense
pragma solidity 0.8.11;
...
"
  ...
  "settings": {
    ...
    "libraries": {
      "libraries/ECDSALibrary.sol": {
        "ECDSALibrary": "0x3af11ead20c39a4fd239d33bee39ffefa6910b6f"
      }
    }
  }
}}