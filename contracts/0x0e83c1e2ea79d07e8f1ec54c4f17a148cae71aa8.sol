...
ð Tokenomics ð
ðToken Name: Eva Inuð
ðToken Symbol: $EVAð
â Total Supply: 1.000.000.000 â
ðµ BUY/SELL Tax = 5% ð(3 % Marketing & 2% Development)ð ðµ
ðµ Max Trx = 1% ðµ
ðµ Max Wallet = 2% ðµ
â Contract Verified â
ð Liquidity LOCKED at team.finance (1 Month)ð
ð Contract Renounced ð
ð fees can't be set higer then 5% & max trx and wallet can't be lower then 1% ð
ð¬Telegram: https://t.me/evainuERC20ð¬
ð¦Twitter: https://twitter.com/evainuerc20ð¦
ðWebsite: https://www.eva-inu.financeð
*/
