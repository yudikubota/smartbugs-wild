...
Ranked fourth among the seven gourd babies.
It can breathe out raging fire, the fire is pure, and the flames of the sun are strong.
The power of the flame is huge, it can burn everything in the world, the fire is strong, and it can also use thunderbolt attacks.

TG:https://t.me/CalabashBro_ETH
...
contract FourthBoyFireBoy is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Fourth Boy Fire Boy";
    string private constant _symbol = "Calabash Bro";
