{{
  "language": "Solidity",
  "sources": {
    "packages/contracts/src/ArrangementOneSale.sol": {
...
"
    ...
    "packages/contracts/lib/fount-contracts/src/auth/Auth.sol": {
      "content": "// SPDX-License-Identifier: Unlicense
...
"
    ...
    "packages/contracts/lib/fount-contracts/src/sales/FixedPrice.sol": {
      "content": "// SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.15;
...
"
    ...
    "packages/contracts/lib/fount-contracts/src/utils/Withdraw.sol": {
      "content": "// SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.15;
...
"
    ...
    "packages/contracts/lib/solmate/src/utils/ReentrancyGuard.sol": {
...
"
    ...
    "packages/contracts/src/interfaces/IOperatorCollectable.sol": {
      "content": "// SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.17;
...
"
  ...
  "settings": {
    "remappings": [
      ...
      "the-garden/=packages/contracts/src/"
    ],
    "optimizer": {
      "enabled": true,
      "runs": 200
