...
contract AimlessFishDynasty is ERC721Enumerable, Ownable {  
    ...
    address public a4_ADT = 0xf770C9AC6bE46FF9D02e59945Ae54030A8A92d3F; // Founder @kenleybrowne
        ...
        // 60% of the Genesis Fund will be forwarded to the DAO, while the final 40% will be used to further the projectâs growth and development.
    ...
    function withdrawTeam(uint256 amount) public payable onlyOwner {
        ...
        require(payable(a4_ADT).send(percent * 38)); // 38% to further the projectâs growth & development plus initial founders dev & marketing expenses.
    }
