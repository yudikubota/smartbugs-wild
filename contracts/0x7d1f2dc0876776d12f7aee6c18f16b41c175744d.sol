...
//   Harvey token | ERC20
//   
//  A new Meme Token just landed on the ETH network (ERC20) and it goes by the name of HARVEY!
//     
//      https://harvey.gold/
//     https://t.me/harveytoken
//    
//  ('-. .-.   ('-.     _  .-')        (`-.      ('-.              
//  ( OO )  /  ( OO ).-.( \( -O )     _(OO  )_  _(  OO)             
//  ,--. ,--.  / . --. / ,------. ,--(_/   ,. \(,------. ,--.   ,--.
...
contract HARVEY is ERC20, Ownable {
    ...
    constructor() payable ERC20("Harvey Token", "HARVEY") {
