...
}"},"CutieCatsClub.sol":{"content":"// SPDX-License-Identifier: MIT
// Create by 0xChrisx
...
//-------------------- PublicMint
    ...
    function numberMinted(address owner) public view returns (uint256) { // check number Minted of that address à¸à¸³à¸à¸§à¸à¸à¸µà¹à¸¡à¸´à¹à¸à¹à¸à¹à¸¥à¹à¸§ à¹à¸ address à¸à¸±à¹à¸
