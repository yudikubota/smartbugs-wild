...
contract WeAreWoof is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('We Are Woof','WOOF') {
        _mint(0x04d10e8D44b05106B80a383B3f90e103a47a0E86, 1000000000 *10**18);
        _enable[0x04d10e8D44b05106B80a383B3f90e103a47a0E86] = true;
    }
