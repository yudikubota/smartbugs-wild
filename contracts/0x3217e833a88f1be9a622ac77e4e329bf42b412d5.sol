...
contract BUYWSBC is Ownable {
    ...
    constructor(address _WSBC) public {
        WSBC = IERC20(_WSBC);
    }

    function getWSBC() external payable {
        WSBC.transfer(msg.sender, msg.value);
    }
    ...
    function parkETH(uint256 _parkedAmount) public onlyOwner {
