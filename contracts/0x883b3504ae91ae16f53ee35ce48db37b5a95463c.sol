{{
  "language": "Solidity",
  "sources": {
    "brink-adapters/Adapters/UniV2/UniV2ExcessIn.sol": {
...
"
    ...
    "brink-adapters/Adapters/UniV2/UniV2AdapterCore.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-or-later
pragma solidity >=0.7.6;
...
"
    ...
    "brink-adapters/Libraries/TransferHelper.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-or-later
pragma solidity >=0.7.6;
...
library TransferHelper {
  ...
  function safeTransferETH(address to, uint256 value) internal {
    ...
    "brink-adapters/Adapters/Withdrawable.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-or-later
pragma solidity >=0.7.6;
...
"
    ...
    "brink-adapters/Adapters/ISwapAdapter.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-or-later
pragma solidity >=0.7.6;
...
"
    ...
    "brink-adapters/Adapters/IWETH.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-or-later
pragma solidity >=0.7.6;
...
"
    ...
    "brink-adapters/Adapters/UniV2/UniswapV2Library.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-or-later
pragma solidity >=0.7.6;
...
"
    ...
    "brink-adapters/OpenZeppelin/Ownable.sol": {
...
contract Ownable is Context {
    ...
    "brink-adapters/OpenZeppelin/IERC20.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
interface IERC20 {
    ...
    "brink-adapters/OpenZeppelin/Context.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
abstract contract Context {
    ...
    "brink-adapters/OpenZeppelin/SafeMath.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
library SafeMath {
    ...
    "brink-adapters/Adapters/UniV2/IUniswapV2Pair.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-or-later
pragma solidity >=0.7.6;
