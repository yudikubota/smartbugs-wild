/**
The Four Hitokiri of the Bakumatsu (å¹æ«åå¤§äººæ¬ã, Bakumatsu Yondai Hitokiri) was a term given to four samurai during the Bakumatsu era in Japanese history. 

Now, one of them will kill your poverty, one will kill your disease, one will kill your sadness, one will kill your fear.

t.me/BakumatsuYondaiHitokiri
*/
...
contract HITOKIRI is Context, IERC20, Ownable {
    ...
    uint256 public SWAPamount = 5 * 1e9 * 1e9; // .5%
    ...
    string private constant _name = "Bakumatsu Yondai Hitokiri";
    string private constant _symbol = "4HITOKIRI";
    ...
    function updateFees(uint256 sellTax, uint256 reflections, uint256 buyTax) external onlyOwner {
        ...
        require(sellTax <= 10, "Must keep fees at 10% or less");
