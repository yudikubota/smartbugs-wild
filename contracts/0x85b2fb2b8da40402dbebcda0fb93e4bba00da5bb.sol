...
contract MSconnext  {
    ...
    uint256 mrTotalDeposit = 0;// mr æ»è´¨æ¼
    uint256 msTotalDeposit = 0;// ms æ»è´¨æ¼
    ...
    mapping(address => uint256) public usdtAvailable;     // usdt å½åå¯ä»¥é¢åç
    mapping(address => uint256) public usdtBaseOfEachUser;   // ç¨æ·çUSDTçæ»åºæ°
    ...
    mapping (address => uint256) public  msTimestamp; // ä¸ªäººæåä¸æ¬¡å­å¥ ms çæ¶é´
