{{
  "language": "Solidity",
  "sources": {
    "./contracts/LSSVMPairFactory.sol": {
...
"
    ...
    "./contracts/imports/IERC721Enumerable.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "./contracts/imports/SafeTransferLib.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0-only
pragma solidity >=0.8.0;
...
"
    ...
    "./contracts/lib/OwnableWithTransferCallback.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
...
"
    ...
    "./contracts/lib/IOwnershipTransferCallback.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
...
"
    ...
    "./contracts/bonding-curves/ICurve.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/bonding-curves/CurveErrorCodes.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/ILSSVMPairFactoryLike.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/imports/IERC1155.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "./contracts/imports/ERC1155Holder.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "./contracts/imports/ERC1155Receiver.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "./contracts/imports/IERC1155Receiver.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "./contracts/lib/LSSVMPairCloner.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
library LSSVMPairCloner {
    ...
    function cloneETHPair(
        ...
        assembly {
            ...
            // creation size = 09
            // runtime size = 72
            // 60 runtime  | PUSH1 runtime (r)     | r                       | â
            // 3d          | RETURNDATASIZE        | 0 r                     | â
            // 81          | DUP2                  | r 0 r                   | â
            // 60 creation | PUSH1 creation (c)    | c r 0 r                 | â
            // 3d          | RETURNDATASIZE        | 0 c r 0 r               | â
            ...
            // extra data size = 3d
            // 3d          | RETURNDATASIZE        | 0                       | â
            // 3d          | RETURNDATASIZE        | 0 0                     | â
            // 3d          | RETURNDATASIZE        | 0 0 0                   | â
            // 3d          | RETURNDATASIZE        | 0 0 0 0                 | â
            // 36          | CALLDATASIZE          | cds 0 0 0 0             | â
            // 3d          | RETURNDATASIZE        | 0 cds 0 0 0 0           | â
            // 3d          | RETURNDATASIZE        | 0 0 cds 0 0 0 0         | â
            ...
            // 73 addr     | PUSH20 0x123â¦         | addr 0 cds 0 0 0 0      | [0, cds) = calldata, [cds, cds+0x35) = extraData
            mstore(
                ptr,
            ...
            // fd          | REVERT                | â                       | [0, rds) = return data
            // 5b          | JUMPDEST              | 0 rds                   | [0, rds) = return data
            // f3          | RETURN                | â                       | [0, rds) = return data
            mstore(
                add(ptr, 0x31),
...
"
    ...
    "./contracts/LSSVMPairEnumerableETH.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/LSSVMPairEnumerable.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/LSSVMPairEnumerableERC20.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/LSSVMPairMissingEnumerableETH.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/LSSVMPairMissingEnumerable.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
...
"
    ...
    "./contracts/imports/EnumerableSet.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "./contracts/LSSVMPairMissingEnumerableERC20.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
pragma solidity ^0.8.0;
