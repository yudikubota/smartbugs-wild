...
/***
Our aim is to help British consumers find a green energy tariff thatâs right for them. And green energy has never been as price competitive as it is now. You can probably switch to green energy and save money!

We started rating green electricity tariffs back in 2000 as the UKâs first website dedicated to green electricity switching.
...
Select the switching service thatâs right for you from the three options below.
***/
...
If youâre on a fixed term plan, with a fixed tariff rate until a given date, 
