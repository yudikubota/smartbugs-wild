...
contract CryptoLuckyBags is ReentrancyGuard, Ownable {
  ...
  // TODO: 1åãããã®åæ°ãè¨­å®ã§ããããã«ãã
  struct LuckyBag {
    uint256 id;
  ...
  uint256 public unsealTimestampLimit = 604800; // éå°æ¥ã¯æå¤§ 1 é±éå
  ...
  // ãã®é¢æ°ãå¼ã³åºãåã«ããã®ã³ã³ãã©ã¯ãã« approval ãä¸ãã¦ããå¿è¦ããã
