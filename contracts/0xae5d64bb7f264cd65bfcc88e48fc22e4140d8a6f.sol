...
/*TELEGRAM  https://t.me/pikapooleth
*/
...
contract pikapooleth is Context, IERC20, Ownable {
    ...
    string private constant _name = "@pikapooleth";
    string private constant _symbol = "$PPOOL";
