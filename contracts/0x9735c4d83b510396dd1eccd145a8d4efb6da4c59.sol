...
contract SUDASWAP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sudo Swap", "wSUDO") {

        uint256 totalSupply = 100 * 1e9 * 1e18;
        
        maxTransactionAmount = totalSupply * 30 / 1000; // 30% maxTransactionAmountTxn
    	...
    	operationsWallet = address(0x9111579FAAe28E1fb7a890AF62b119F25F6A84F1); // set as operations wallet
