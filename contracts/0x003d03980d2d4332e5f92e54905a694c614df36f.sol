...
"
    ...
    "contracts/core/interfaces/ISoundEditionV1_1.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.16;
...
"
    ...
    "contracts/core/utils/ArweaveURILib.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.16;
...
"
    ...
    "contracts/core/utils/MintRandomnessLib.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.16;
...
library FixedPointMathLib {
    ...
    /// @dev Calculates floor(a Ã b Ã· denominator) with full precision.
    ...
    /// @dev Calculates floor(a Ã b Ã· denominator) with full precision, rounded up.
    /// Throws if result overflows a uint256 or when the denominator is zero.
