...
https://jiraiyainuerc.com/
https://t.me/JiraiyaInuerc
*/
...
contract JiraiyaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jiraiya Inu";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x93CCA58F8F3666Ace353be4110551B04fEecaDC1);
        _feeAddrWallet2 = payable(0x93CCA58F8F3666Ace353be4110551B04fEecaDC1);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = 9999999999999 * 10 ** 9;
        tradingOpen = true;
    ...
    function removeStrictTxLimit() public onlyOwner {
        _maxTxAmount = 999999999999999 * 10**9;
    }
