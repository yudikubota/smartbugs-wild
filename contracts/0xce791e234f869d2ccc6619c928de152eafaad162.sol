{{
  "language": "Solidity",
  "sources": {
    "contracts/RarityCompositingEngine.sol": {
...
"
    ...
    "contracts/RendererPropsStorage.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "@abf-monorepo/protocol/contracts/renderers/LayerCompositeRenderer.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "@abf-monorepo/protocol/contracts/interfaces/IRenderer.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
interface IRenderer is IERC165 {
  ...
  function attributes(bytes calldata props) external view returns (string memory);
    ...
    "@abf-monorepo/protocol/contracts/libraries/SvgUtils.sol": {
      "content": "// SPDX-License-Identifier: MIT
