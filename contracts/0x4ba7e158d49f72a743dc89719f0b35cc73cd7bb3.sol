...
-Congrats. You've found my insider play! 

-75% of the tax funds will be used for buybacks at $150K market cap. 0x2fd2c31fE8f0D34001547Ea2f0D64253DbBC461F. I will retain 25% for gifting you this insider play.

-Those who diamond hand for the first 3 days will be airdropped Alpha NFT's containing further instruction. 

-The holder who creates the official TG will also be airdropped the Alpha NFT.
...
contract InsiderPlay is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Insider Play";
    string private constant _symbol = "iPlay";
