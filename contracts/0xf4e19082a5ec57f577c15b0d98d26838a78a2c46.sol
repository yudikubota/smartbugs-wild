...
"
    ...
    "contracts/CustomMintRenameWithERC20.sol": {
      "content": "pragma solidity >=0.6.0 <0.9.0;
//SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/CustomMintRenameWithEth.sol": {
      "content": "pragma solidity >=0.6.0 <0.9.0;
//SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/CustomMintRename.sol": {
      "content": "pragma solidity >=0.6.0 <0.9.0;
//SPDX-License-Identifier: MIT
...
abstract contract CustomMintRename is Ownable, ERC721 {
    ...
    // sum of ânâ natural numbers to 99.
    // 99*(100)/2 = 4950
    //
