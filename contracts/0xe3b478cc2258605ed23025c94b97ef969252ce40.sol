...
contract BlockArtFactory is Ownable {
        ...
        returns (uint256)
    {
        ...
        // style supply cap
        uint256 ssc = _style.getStyleFeeMul(styleId);
    ...
    function addStyle(uint256 styleId) external onlyOwner {
        asl[styleId] = true;
