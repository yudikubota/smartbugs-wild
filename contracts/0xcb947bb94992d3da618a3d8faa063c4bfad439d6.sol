/**
    With rakish eye and plenished crop, oblivious of the hunter's gun. Upon the naked ash-tree top. The Crow sits basking in the sun.

A crow carries soul to the land of the dead. But sometimes,  a terrible sadness is carried with it and the soul can't rest and let the souls wonder to detest. Then the crow can bring that soul back to put the wrong things right were every can be laid to rest.

Deity is Risen

https://t.me/DeityERC20

https://medium.com/@CrowETH
*/
...
pragma solidity ^0.6.12;
    ...
    contract DEITY is Context, IERC20, Ownable {
        ...
        string private _name = 'DEITY';
        string private _symbol = 'DEITY';
