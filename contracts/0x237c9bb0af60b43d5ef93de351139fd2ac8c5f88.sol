...
7.	Change or Termination of Service
    ...
    We continually upgrade the application to provide the best experience, and may do so without further notice. We may change these terms from time to time. When making any change, we will provide updated terms in the application, and update the âlast updateâ date at the beginning of these terms accordingly. After the terms are updated, your continued access to or use of the application shall constitute your binding acceptance of various updates.
