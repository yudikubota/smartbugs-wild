{{
  "language": "Solidity",
  "sources": {
    "contracts/optimistic-ethereum/iOVM/bridge/messaging/iOVM_CrossDomainMessenger.sol": {
...
"
    ...
    "contracts/optimistic-ethereum/OVM/bridge/tokens/OVM_L2StandardBridge.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/bridge/tokens/iOVM_L1StandardBridge.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/bridge/tokens/iOVM_L1ERC20Bridge.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/bridge/tokens/iOVM_L2ERC20Bridge.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/constants/Lib_PredeployAddresses.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/standards/IL2StandardERC20.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/optimistic-ethereum/OVM/predeploys/OVM_SequencerFeeVault.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/predeploys/OVM_ETH.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/standards/L2StandardERC20.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.5.16 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/standards/IWETH9.sol": {
...
"
    ...
    "contracts/optimistic-ethereum/OVM/bridge/tokens/OVM_L1StandardBridge.sol": {
      "content": "// SPDX-License-Identifier: MIT
// @unsupported: ovm
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/predeploys/OVM_ECDSAContractAccount.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/predeploys/iOVM_ECDSAContractAccount.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/wrappers/Lib_ExecutionManagerWrapper.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/predeploys/OVM_ProxyEOA.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/test-libraries/codec/TestLib_EIP155Tx.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/trie/Lib_SecureMerkleTrie.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/execution/iOVM_StateManagerFactory.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/verification/Abs_FraudContributor.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/trie/Lib_MerkleTrie.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/verification/OVM_StateTransitionerFactory.sol": {
      "content": "// SPDX-License-Identifier: MIT
// @unsupported: ovm
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/verification/iOVM_StateTransitionerFactory.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/verification/OVM_BondManager.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/test-helpers/Mock_FraudVerifier.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/utils/Lib_Buffer.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/execution/OVM_StateManagerFactory.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/libraries/bridge/Lib_CrossDomainUtils.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/bridge/messaging/iOVM_L1CrossDomainMessenger.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/bridge/messaging/OVM_L1MultiMessageRelayer.sol": {
      "content": "// SPDX-License-Identifier: MIT
// @unsupported: ovm
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/bridge/messaging/iOVM_L1MultiMessageRelayer.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/bridge/messaging/iOVM_L2CrossDomainMessenger.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/predeploys/iOVM_L1MessageSender.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/iOVM/predeploys/iOVM_L2ToL1MessagePasser.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/predeploys/OVM_L2ToL1MessagePasser.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/predeploys/OVM_L1MessageSender.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/predeploys/OVM_GasPriceOracle.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
...
"
    ...
    "contracts/optimistic-ethereum/OVM/bridge/tokens/OVM_L2StandardTokenFactory.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/test-libraries/utils/TestLib_EthUtils.sol": {
      "content": "// SPDX-License-Identifier: MIT
// @unsupported: ovm
pragma solidity >0.5.0 <0.8.0;
pragma experimental ABIEncoderV2;
...
"
    ...
    "contracts/optimistic-ethereum/mockOVM/verification/mockOVM_BondManager.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >0.5.0 <0.8.0;
