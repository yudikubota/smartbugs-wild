...
contract Custodian {
        ...
        returns (bool success)
    {
        ...
        address signer1 =  ecrecover(keccak256(abi.encodePacked("Ethereum Signed Message:
32", _requestMsgHash)), _recoveryByte1,_ecdsaR1, _ecdsaS1);
        require(signerSet[signer1]);

        address signer2 =  ecrecover(keccak256(abi.encodePacked("Ethereum Signed Message:
