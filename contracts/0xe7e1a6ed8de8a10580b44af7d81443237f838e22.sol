{{
  "language": "Solidity",
  "sources": {
    "/var/app/current/contracts/IndelibleERC721A.sol": {
      "content": "
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Base", unicode"Tongue", unicode"Teeth", unicode"Cyclops", unicode"Eyes", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"AAAHH!!! OnChain Monsters", unicode"AAAHHH!!! OnChain Monsters...is a collection of 3000 little monsters generated at mint, on chain. This is a phucking.eth project. There may be more utility screen printed later...", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/85d507e6-d0f0-407c-a692-81fc89063eaa", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/85d507e6-d0f0-407c-a692-81fc89063eaa", "aaahh.wtf", 500, "0x7335ce9EedE1f9d8940657B0d8a01080d3B5eA9A");

        constructor() ERC721A(unicode"AAAHH!!! OnChain Monsters", unicode"AAAHH") {
            TIERS[0] = [30,88,90,126,165,216,216,224,321,330,350,380,464];
TIERS[1] = [25,75,135,179,206,244,266,315,483,508,564];
TIERS[2] = [67,121,180,207,225,369,588,592,651];
TIERS[3] = [1,1,5,5,7,7,7,50,2917];
TIERS[4] = [5,5,10,10,12,12,14,14,18,18,29,31,51,58,65,75,77,79,107,108,113,118,119,127,147,149,161,186,207,233,303,339];
TIERS[5] = [23,29,33,39,54,67,104,119,121,146,166,184,205,229,261,327,380,513];
TIERS[6] = [3,5,11,12,16,17,20,30,47,50,58,64,86,86,91,102,105,109,122,151,172,181,185,194,250,263,267,303];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"AAAHH!!! OnChain Monsters #");
...
"
    ...
    "/var/app/current/contracts/DynamicBuffer.sol": {
...
library DynamicBuffer {
    ...
    "/var/app/current/contracts/HelperLib.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
library HelperLib {
    ...
    "/var/app/current/contracts/SSTORE2.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
library SSTORE2 {
  ...
  */
  function read(address _pointer, uint256 _start, uint256 _end) internal view returns (bytes memory) {
    ...
    "/var/app/current/contracts/utils/Bytecode.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
