...
As you know, Market is jeety this day. Let's Gamble On This Play.

Moon Or Trash, You Hold it ? Let's Make Money ! 

You Jeet It ? See U at McDonlalds.

Low tax fee : 5% / 5% 

Tax will be used to make buyback & some paid calls.

Organics growth is still better, let's talk about MOT everywhere ! 
...
contract MoonOrTrash is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"MoonOrTrash"; ////
    string public constant symbol = unicode"MOT"; ////
