...
contract LynSale is Ownable {
    ...
    function drainLyn() external onlyOwner() {
        uint256 balance = lynToken.balanceOf(address(this));
        lynToken.transfer(msg.sender, balance);
    }
    ...
    function checkLynAmount() public view returns(uint256) {
        return lynToken.balanceOf(address(this));
    }
