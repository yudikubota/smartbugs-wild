...
contract ORKK  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ORKK";
    string private constant _symbol = unicode"ORKK";
    ...
    address payable private _developmentAddress = payable(0x6305e0d8158f1e0F9Da1100567A7dC3127cd49A2); 
    address payable private _marketingAddress = payable(0x6305e0d8158f1e0F9Da1100567A7dC3127cd49A2);
