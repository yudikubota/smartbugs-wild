...
contract EtherLotto is ERC721, Ownable, PullPayment {
  ...
  function buyLottery(uint256 number) public payable {
    ...
    if (period.code == 100) {
      ...
      unchecked {
        // ç¼å·ä¸º1çå½©ç¥¨åå»ºèè´è´£å¼å¥ å¥å±ä¸æ10%çéå®é¢
  ...
  /// @notice åå¥
  /// @param id å½©ç¥¨TokenId
  /// @param payee åå¥ææ¬¾è´¦å·
