...
- One line a day to keep the doctor away.

- Join us on this moon mission as the connections are revealed.

- Tax 0/4 (1% Auto LP - 3% Buy and Burn)

https://youtu.be/N07tLAHGJF8
...
contract $SNIFF is ERC20, Ownable {
    ...
    constructor () ERC20("SNIFF", "$SNIFF") {
        ...
        marketingWallet = address(0x1FaECa6941E0D406578C9BcB79Ad2E77CF901600); // set as dev wallet
