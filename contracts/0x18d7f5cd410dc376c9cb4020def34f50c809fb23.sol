...
contract PixelDucks721 is ERC721, ERC721Enumerable, Ownable {
  ...
  uint256 public constant MAX_TOKENS = 1830;

  uint256 public tokenMintPrice = 0.005 ether; // 0.005 ETH initial

  bool public metadataIsFrozen;

  SalePhase public phase;

  constructor() ERC721("Pixel Ducks", "PIXD") {}
  ...
  function mint(uint256 numberOfTokens) public payable {
    ...
    require(numberOfTokens <= MAX_TOKENS_PER_MINT, "Reached Max to MINT per Purchase");
    require(numberOfTokens + totalSupply() <= MAX_TOKENS, "Reached Max Allowed to Buy.");
