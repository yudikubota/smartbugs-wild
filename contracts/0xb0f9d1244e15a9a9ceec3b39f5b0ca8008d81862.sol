...
"
    ...
    "node_modules/alchemist/contracts/aludel/Aludel.sol": {
...
"
    ...
    "node_modules/alchemist/contracts/aludel/PowerSwitch.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
"
    ...
    "node_modules/alchemist/contracts/aludel/Powered.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
"
    ...
    "node_modules/alchemist/contracts/aludel/RewardPool.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
"
    ...
    "node_modules/alchemist/contracts/crucible/Crucible.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
pragma abicoder v2;
    ...
    Initializable
{
    ...
    function checkBalances() external view override returns (bool validity) {
        ...
        for (uint256 index; index < count; index++) {
            ...
            LockData storage _lockData = _locks[_lockSet.at(index)];
            // if insufficient balance and noât shutdown, return false
...
"
    ...
    "node_modules/alchemist/contracts/crucible/EIP712.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
"
    ...
    "node_modules/alchemist/contracts/crucible/ERC1271.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
"
    ...
    "node_modules/alchemist/contracts/crucible/OwnableERC721.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
"
    ...
    "node_modules/alchemist/contracts/factory/IFactory.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
"
    ...
    "node_modules/alchemist/contracts/factory/InstanceRegistry.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
"
    ...
    "src/contracts/aludel/Aludel.sol": {
...
contract Aludel is IAludel, Ownable, Initializable, Powered {
    ...
    "src/contracts/aludel/IAludel.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
interface IAludel is IRageQuit {
    ...
    "src/contracts/powerSwitch/PowerSwitch.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
contract PowerSwitch is IPowerSwitch, Ownable {
    ...
    "src/contracts/powerSwitch/Powered.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.4;
...
contract Powered is IPowered {
  ...
  "settings": {
    "remappings": [
      ...
      "alchemist/=node_modules/alchemist/",
      "ds-auth/=node_modules/ds-auth/",
      "ds-math/=node_modules/ds-math/",
      "ds-test/=node_modules/ds-test/",
      "ds-token/=node_modules/ds-token/",
