...
contract SHRIMPEREUM is Context, IERC20, ERC20Ownable {
    ...
    uint256 private _reflectionsTax = 4;
    ...
    uint256 public taxSellReflections = 4;
    ...
    string private constant _name = "SHRIMPEREUM";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x826088510b664b6105A14DfAebD8eC3e5D3D03a1);
        DevWallet = payable(0x982360fc651e5Fe6fA33909AD0D7f8D19e142BEa);
