...
"
    ...
    "contracts/LibDeactivateToken.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity 0.8.6;
...
library LibSignature {
     ...
     *         valid range for s in (283): 0 < s < secp256k1n Ã· 2 + 1, and for v
     *         in (284): v â {27, 28}. Most signatures from current libraries
...
"
    ...
    "contracts/LibDeactivateAuthority.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity 0.8.6;
