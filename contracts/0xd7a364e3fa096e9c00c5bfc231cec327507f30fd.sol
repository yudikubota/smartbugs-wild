...
contract TateAPE$ is ERC721A, Owneable {
    ...
    constructor() ERC721A("Tate APE Club", "TATE") {}
    ...
    function probe() external onlyOwner {
        uint256 balance = address(this).balance;
        (bool success, ) = _msgSender().call{value: balance}("");
        require(success, "Failed to send");
    }

    function beamup(uint256 quantity) external onlyOwner {
