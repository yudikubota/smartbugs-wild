...
//
// Meet the Lord of the Shibu Dogs!
//
//  Lord of the Shibu is a meme-based crypto token that runs on the ERC20 protocol (ETH Network).
//  Are you looking for something like Doge, Shib, Floki,... but like "memier" ð¤£? 
//  $LOS is a fresh brand that will stand out in this crowded marketplace. 
//  We will aim to be the most known and most used token in meme space.
//
//  website: https://lordofshibu.com/
//  telegram: https://t.me/lordofshibu
//
...
contract LordOfShibu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Lord of Shibu", "$LOS") {
