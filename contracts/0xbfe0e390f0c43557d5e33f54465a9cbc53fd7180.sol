...
contract HTest4 is ERC721AQueryable, ERC2981 , Ownable, Pausable {//ãããæ¸ãæãã
    using Strings for uint256;
    bool public revealed;
    string public baseURI = "";
    string public notRevealedURI = "";
    uint256 public saleHCost = 0.005 ether;//ãããæ¸ãæãã
    uint256 public saleGCost = 0.005 ether;//ãããæ¸ãæãã
    uint256 public publicCost = 0.005 ether;//ãããæ¸ãæãã

    bool public saleHStart = false;
    bool public saleGStart = false;
    bool public publicStart = false;
    address public royaltyAddress;
    uint96 public royaltyFee = 500;//ãããæ¸ãæãã

    uint256 constant public MAX_SUPPLY = 22;
    uint256 constant public MINTLIMIT_H = 3;//ãããæ¸ãæãã
    uint256 constant public MINTLIMIT_G = 1;//ãããæ¸ãæãã
    uint256 constant public MINTLIMIT_P = 1;//ãããæ¸ãæãã
    ...
    constructor(
    ) ERC721A("HTest4","HTV4") {//ãããæ¸ãæãã
    ...
    function withdrawRevenueShare() external onlyOwner {
        ...
        address artist = payable(0x2aE5393CFE777a65f30692dBf0aE9Aaa20352b40);//ãããæ¸ãæãã
        address engineer = payable(0x7a1824E35FFb5c76AFd06984700957C5DF26cC93);//ãããæ¸ãæãã
        address engineer2 = payable(0x2901f5FdAe6f75f0e1f0D6fD3905D3096ced3E86);//ãããæ¸ãæãã
        address marketer = payable(0x82c28AeE93e1647ed16025f25DC5b5582aA10AAE);//ãããæ¸ãæãã
        bool success;
