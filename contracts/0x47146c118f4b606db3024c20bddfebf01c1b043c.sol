...
contract Activision_Blizzard_Gaming_Token is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Activision Blizzard Gaming Token";
  string constant tokenSymbol = "BLZ";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 35700000000000000000000;
