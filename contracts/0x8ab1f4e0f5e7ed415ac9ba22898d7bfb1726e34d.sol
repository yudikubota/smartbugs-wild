...
//-----------------------------------------------------------------------
// äºåè²©å£²æå ±ï¼ã¤ã³ã¿ã¼ãã§ã¤ã¹
//-----------------------------------------------------------------------
interface IPresaleInfo {
    //----------------------------------------
    // ç»é²ç¢ºèªããã¦ãããï¼
    //----------------------------------------
...
contract Token is Ownable, ERC721{
    ...
    constructor() Ownable() ERC721( TOKEN_NAME, TOKEN_SYMBOL ){
        // ãéãå¼ãåºããäºº
        _accountant = 0xda1B1849EeF51f1F5EfF49dA1220ebb89a5ef2FF;   // æ¬çª
        ...
        // ã¹ãã¼ã¯é¢é£ï¼ãªãªã¼ã¹æã¯ãªãã«ãã¦ããï¼
        _stake_suspended = true;
        _unstake_suspended = true;
    }

    //---------------------------------------------------
    // [public] ä¸è¬è²©å£²ãå©ç¨å¯è½ãï¼
    //---------------------------------------------------
    function isSaleAvailable() public view returns (bool) {
        ...
        // çµäºï¼_sale_endãï¼ã®å ´åã¯ç¡æé
    ...
    function isPresaleAvailable() public view returns (bool) {
        ...
        // çµäºï¼_presale_endãï¼ã®å ´åã¯ç¡æé
    ...
    //---------------------------------------------------
    // [public] äºåç»é²æ¸ã¿ã®ã¦ã¼ã¶ã¼ãï¼
    //---------------------------------------------------
    ...
    //--------------------------------------------
    // [external/onlyOwner] ãã¼ã¯ã³ã®giveaway
    //--------------------------------------------    
    ...
    //--------------------------------------------------------
    // [external] å¼ãåºããã¢ã«ã¦ã³ãã®ç¢ºèª
    //--------------------------------------------------------
    ...
    //--------------------------------------------------------
    // [external/onlyOwner] å¼ãåºããã¢ã«ã¦ã³ãã®è¨­å®
    //--------------------------------------------------------
    ...
    //--------------------------------------------------------
    // [external/onlyOwner] _base_url ã®è¨­å®
    //--------------------------------------------------------
    ...
    //---------------------------------------------------
    // [external/onlyOwner] ã¡ã¿ãã¼ã¿ã®URLã®ä¿®å¾©
    //---------------------------------------------------
    ...
    //---------------------------------------------------
    // [external] æå ±ã®ä¸æ¬åå¾ï¼ãã­ã³ãåãï¼
    //---------------------------------------------------
    ...
    //---------------------------------------------------
    // [external/onlyOwner] ã¹ãã¼ã¯ã­ã³ã°ã®åæ­¢
    //---------------------------------------------------
    ...
    //---------------------------------------------------
    // [external] ã¹ãã¼ã­ã³ã°ç¶æ³ã®ç¢ºèª
    //---------------------------------------------------
    ...
    //--------------------------------------------------------
    // [external] ãã¼ã¯ã³ãã¹ãã¼ã¯ãã¦ããã¢ãã¬ã¹ã®ç¢ºèª
    //--------------------------------------------------------
    ...
    //--------------------------------------------------------
    // [external/onlyAccountant] å¼ãåºã
    //--------------------------------------------------------
