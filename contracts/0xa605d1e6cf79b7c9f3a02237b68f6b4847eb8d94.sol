...
- âï¸ Supply Name: Pearl of the Orient Seas - Creating a better life for everyone
- âï¸ Symbol: PEARL
- âï¸ Anti-Whale System (3% Sell Price Impact)
- âï¸ Anti-Serial Selling System (Anti-Dump)
- âï¸ Manual Burning and Buyback capability
- âï¸ Send to Buyback Wallet per transaction: 2% (Sent on ETH)
- âï¸ Send to Marketing Wallet per transaction: 1% (Sent on ETH)
- âï¸ Send to Team Wallet per transaction: 5% (Sent on ETH)
- âï¸ Send to Charity Wallet per transaction: 2% (Sent on ETH)
- âï¸ Implemented Dynamic Sell Logic (Anti-Bot)
