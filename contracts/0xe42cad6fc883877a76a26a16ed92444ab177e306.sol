{{
  "language": "Solidity",
  "sources": {
    "contracts/custom-drops/TheMerge.sol": {
      "content": "/*******************************************************************************
...
Peter Szilagyi,  Andrei Maiboroda,   Jose Hugo de la cruz Romero,   PaweÅ Bylica,
...
Carl Beekhuizen,    Dankrad Feist,    Dmitry Khovratovich,     Francesco dâAmato,
George Kadianakis,    Hsiao Wei Wang,    Justin Drake,    Mark Simkin,     Proto,
Zhenfei Zhang, Anders, BarnabÃ© Monnot, Caspar Schwarz-Schilling,  David Theodore,
...
Jim mcDonald,   Peter Davies,    Adrian Manning,    Diva MartÃ­nez,    Mac Ladson,
...
Tuyen Nguyen,  Daniel Caleda,   Jorge Mederos,   Åukasz Rozmej,   Marcin Sobczak,
Marek MoraczyÅski,  Mateusz JÄdrzejewski,  Tanishq,  Tomasz Stanzeck,   James He,
Kasey Kirkham, Nishant Das, potuz, Preston Van Loon, RadosÅaw Kapka, Raul Jordan,
