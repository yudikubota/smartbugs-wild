    ...
    ReentrancyGuard
{
     ...
     * be set for the hedged and unhedged â classic â liquidity tranches.
     ...
     * for the hedged and unhedged â classic â liquidity tranches.
     ...
     * @param value The utilization ratio in a range of 50% â 100%
     **/
     ...
     * @param value The collateralization ratio in a range of 30% â 100%
     **/
...
"
    ...
    "contracts/Options/SimplePriceCalculator.sol": {
      "content": "pragma solidity 0.8.6;
...
"
    ...
    "contracts/Options/PriceCalculatorWtihUtilizationRate.sol": {
      "content": "pragma solidity 0.8.6;
