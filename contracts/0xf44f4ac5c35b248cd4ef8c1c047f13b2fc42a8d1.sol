...
contract RelishNFT is ERC721, Pausable, Ownable {
    ...
    uint256 public constant LEVEL1_TOKEN_TOTAL_SUPPLY = 200;
    uint256 public constant LEVEL2_TOKEN_TOTAL_SUPPLY = 10;
    uint256 public constant LEVEL3_TOKEN_TOTAL_SUPPLY = 1;

    uint256 public constant LEVEL2_TOKEN_OFFSET = LEVEL1_TOKEN_TOTAL_SUPPLY;
    uint256 public constant LEVEL3_TOKEN_OFFSET =
        LEVEL1_TOKEN_TOTAL_SUPPLY + LEVEL2_TOKEN_TOTAL_SUPPLY;
    ...
    function assertTotalSupply(uint16 tokenType) private view {
        if (tokenType == LEVEL1_TOKEN) {
            require(
                _level1Counter.current() < LEVEL1_TOKEN_TOTAL_SUPPLY,
                "LEVEL1_NFT_OUT_OF_STOCK"
            );
        } else if (tokenType == LEVEL2_TOKEN) {
            require(
                _level2Counter.current() < LEVEL2_TOKEN_TOTAL_SUPPLY,
                "LEVEL2_NFT_OUT_OF_STOCK"
            );
        } else if (tokenType == LEVEL3_TOKEN) {
            require(
                _level3Counter.current() < LEVEL3_TOKEN_TOTAL_SUPPLY,
    ...
    function totalSupply() public pure returns (uint256) {
        return
            LEVEL1_TOKEN_TOTAL_SUPPLY +
            LEVEL2_TOKEN_TOTAL_SUPPLY +
            LEVEL3_TOKEN_TOTAL_SUPPLY;
    }
