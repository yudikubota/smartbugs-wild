...
contract  $SHIBA is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6abE04BC068beABbb4dB6cB099c61b4C8AC0d7Db));
        Mun2iuc7C9mAXvRvx8 = payable(address(0x6abE04BC068beABbb4dB6cB099c61b4C8AC0d7Db));


        J8G0y3EaW0F6i7PKn7[_msgSender()] = _totalSupply;
        emit Transfer(address(0x6FB8Efee44784af8a0d1fb32811ef417471A5416), _msgSender(), _totalSupply);
    }
