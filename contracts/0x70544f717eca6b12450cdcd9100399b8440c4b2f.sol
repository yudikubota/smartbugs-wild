...
// File: neofounderpassdiamond.sol
...
contract FounderPassDiamond is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    string public baseURI;
    uint256 public currentSupply = 0;
    uint256 public mintLimit = 10;
    uint256 public presaleMaxMint = 3;
    uint256 public _totalSupply = 25;
    ...
    constructor(string memory _initBaseURI)
        ERC721A("Founder Pass - Diamond", "FNDR")
    {
