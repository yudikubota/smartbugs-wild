 ...
 ?9 ETH LIQ LAUNCH
  ...
  No Dev Tokens ?
   ...
   ?   ?  -SLIPPAGE 12%+  ?   ?   
    ...
    â¼ï¸Token Name : BackBezos
    â¼ï¸Token Symbol : $BackBezos$
    â¼ï¸Total supply : 1,000,000,000?
    â¼ï¸Initial BURN : 300,000,000 ?  
    â¼ï¸Tokens listing : 700,000,000 ??
    â¼ï¸12% Tax on each transactoin -4% Burned 4% LIQUIDIT 4%To Vitalik's Wallet
    â¼ï¸LP tokens will be burned forvever 
    â¼ï¸Ownership Renounced soon after launch
    â¼ï¸Anti-Bot : Bots gets Blacklisted automatically(Increasing LIQUIDITY IN POOL)
