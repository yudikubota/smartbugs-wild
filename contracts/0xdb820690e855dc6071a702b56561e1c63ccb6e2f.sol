...
}"},"LAND.sol":{"content":"pragma solidity ^0.8.4;
...
contract RevenueLandCollective is RewardsToken {
    using SafeMath for uint256;
    using Address for address;
    ...
    address payable private _devWalletAddress =
        payable(0x783F694C93faf3eF600bf5bD5Be8AF6f06A2ebbc);
    ...
    uint256 private minTokensBeforeSwap = 250000 * 10**9;
    ...
    constructor() ERC20("Revenue Land Collective", "LAND") {
