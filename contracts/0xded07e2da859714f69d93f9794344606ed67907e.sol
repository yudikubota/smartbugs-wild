{{
  "language": "Solidity",
  "sources": {
    "contracts/periphery/Manager.sol": {
...
"
    ...
    "contracts/interfaces/manager/IManager.sol": {
...
"
    ...
    "contracts/periphery/base/ManagerBase.sol": {
      "content": "// SPDX-License-Identifier: BUSL-1.1
pragma solidity 0.8.10;
...
"
    ...
    "contracts/periphery/base/PositionManager.sol": {
      "content": "// SPDX-License-Identifier: BUSL-1.1
pragma solidity 0.8.10;
...
"
    ...
    "contracts/periphery/base/SwapManager.sol": {
      "content": "// SPDX-License-Identifier: BUSL-1.1
pragma solidity 0.8.10;
...
"
    ...
    "contracts/periphery/base/SelfPermit.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity 0.8.10;
...
"
    ...
    "contracts/interfaces/manager/IManagerBase.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
"
    ...
    "contracts/interfaces/manager/ISwapManager.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
"
    ...
    "contracts/interfaces/manager/IPositionManager.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
"
    ...
    "contracts/interfaces/manager/ISelfPermit.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
library Positions {
     ...
     * @return feeAmtOut0       Amount of fee0 to transfer to owner account (â¤ 2^(128+80))
     * @return feeAmtOut1       Amount of fee1 to transfer to owner account (â¤ 2^(128+80))
     */
    function update(
...
"
    ...
    "contracts/interfaces/manager/IERC721Extended.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
"
    ...
    "contracts/interfaces/hub/positions/IMuffinHubPositions.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
library PoolMath {
    ...
    /// i.e. âP1 = L âP0 / (L + Îx * âP0)   if no overflow
    ///          = L / (L/âP0 + Îx)         otherwise
    ///
    /// @dev Rounding rules:
    ...
    function calcAmtsForLiquidity(
        ...
        // we assume {sqrtP, sqrtPLower, sqrtPUpper} â  0 and sqrtPLower < sqrtPUpper
        unchecked {
...
library TickMath {
     ...
     *
     * Let b_i = the i-th bit of x and b_i â {0, 1}
...
"
    ...
    "contracts/periphery/base/ERC721Extended.sol": {
      "content": "// SPDX-License-Identifier: BUSL-1.1
pragma solidity 0.8.10;
...
"
    ...
    "contracts/interfaces/hub/positions/IMuffinHubPositionsActions.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
"
    ...
    "contracts/interfaces/hub/positions/IMuffinHubPositionsView.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
"
    ...
    "contracts/periphery/base/ERC721.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/interfaces/common/IERC1271.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/interfaces/common/IERC721Descriptor.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0-only
pragma solidity ^0.8.0;
...
"
    ...
    "contracts/interfaces/common/IERC20PermitAllowed.sol": {
      "content": "// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
