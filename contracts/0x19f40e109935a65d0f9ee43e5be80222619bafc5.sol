...
/*
ðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðªðª                                                                       
...
contract ComicsByCookie is ERC1155, Ownable {
    ...
    function contractDev() public pure returns(string memory){
        string memory dev = unicode"ð¸ https://www.halfsupershop.com/ ð¸";
        return dev;
    }
