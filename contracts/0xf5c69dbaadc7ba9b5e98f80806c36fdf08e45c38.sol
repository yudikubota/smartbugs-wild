...
contract KatanaTweet is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x4fFF9C94F4cD8C3fc0B34AC6341949F0F29867B3));

    string private _name = "KatanaTweet";
    string private _symbol = "KatanaTweet";
