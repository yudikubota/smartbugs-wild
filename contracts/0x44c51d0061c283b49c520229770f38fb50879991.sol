{{
  "language": "Solidity",
  "sources": {
    "/Users/haari/Dropbox/haari-dev-env/Solidity/smart-contract/contracts/LorcPreSale.sol": {
...
contract LorcPreSale is Ownable, Pausable {
  ...
  event BuyLORCWithUSDT(address account, address token, uint amount, uint _ethRate);
    ...
    "/Users/haari/Dropbox/haari-dev-env/Solidity/smart-contract/contracts/access/Ownable.sol": {
      "content": "// SPDX-License-Identifier: MIT
