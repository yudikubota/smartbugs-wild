...
contract BlackVitalik  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Vitalik";
    ...
    address payable private _developmentAddress = payable(0xa05e7ADAB4551cb5e479c8751F5D16287D3AF90a); 
    address payable private _marketingAddress = payable(0x840d2a2daFCAD4787ede4C2e464Dce2360f967dB);
