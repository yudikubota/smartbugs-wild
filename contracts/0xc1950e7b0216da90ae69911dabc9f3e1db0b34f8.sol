{{
  "language": "Solidity",
  "sources": {
    "contracts/MarryVaultFactory.sol": {
...
contract MarryStrgtVault is ERC4626, Owned {
    ...
    error MarryStrgtVault__HarvestAtSameBlock();
    ...
    constructor(
        ...
        ERC4626(
            ...
            string(abi.encodePacked("yoS_Strgt_", _asset.symbol()))
        )
        Owned(_owner)
    {
    ...
    function harvest(
        ...
        if (lastHarvestBlock == block.number)
            revert MarryStrgtVault__HarvestAtSameBlock();
...
"
    ...
    "contracts/interfaces/IStrgtPool.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/interfaces/IStrgtRouter.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0;
