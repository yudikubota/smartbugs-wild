...
contract SafeTransfer is AccessControl {
   ...
   function autoRetrieveERC721(
        ...
        onlyActivator()
    {
        ...
        require(ecrecover(keccak256(abi.encodePacked("", DOMAIN_SEPARATOR, id1)), v, r, s) == from, "SafeTransfer: wrong signature");
        ...
        onlyActivator()
    {
        ...
        require(ecrecover(keccak256(abi.encodePacked("", DOMAIN_SEPARATOR, tinfo.id1)), v, r, s) == from, "SafeTransfer: wrong signature");
