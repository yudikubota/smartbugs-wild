...
contract Griffins is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("Griffins", "GRIFFINS") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0x56460fA1F2e96D827DaCccE39f153ACBD221fe72); // CHANGE THIS TO YOURS
        devWallet = payable(0x5e042ee8989ced4fd1526285CD49C87cb886CE90); // CHANGE THIS TO YOURS
