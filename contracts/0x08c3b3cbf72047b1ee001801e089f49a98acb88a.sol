...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1670576940;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1E69522100D2BAD263500555922A33B53FaD1365];
  address public erc20Payable = 0x1E69522100D2BAD263500555922A33B53FaD1365;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmP88zV6Z37fhwyhqv3rM3QHLNdr7Ww4Et4MFS38drdzZL/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/21LiYpzJEnD76Pn7DzLQ/contract-metadata";
  }
...
// File: contracts/AlternativeHumanHeartContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlternativeHumanHeartContract is RamppERC721A {
    constructor() RamppERC721A("Alternative Human Heart", "ATH"){}
}
