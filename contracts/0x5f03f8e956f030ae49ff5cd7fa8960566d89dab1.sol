...
contract BSCToken is owned, token {
    ...
    /// @param newSellPrice Price applied when an address sells its tokens, amount in WEI (1ETH = 10Â¹â¸WEI).
    /// @param newBuyPrice Price applied when an address buys tokens, amount in WEI (1ETH = 10Â¹â¸WEI).
