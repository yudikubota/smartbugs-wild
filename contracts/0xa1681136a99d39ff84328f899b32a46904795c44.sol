...
contract ERC777 is IERC777, IERC20 {
    ...
    // data
    string public companyName = "Der Firmenname nach wunsch";
    ...
    function addAssetsTransaction(string calldata _dateTime, string calldata _action,
        ...
        if (_defaultOperators[msg.sender]) {        incrementCount();
    ...
    function setCompanyName(string calldata _companyName) external {
        if (_defaultOperators[msg.sender]) {
...
contract TokenMintERC777Token is ERC777 {
    ...
    string private _symbol = "E7T19";
    string private _name = "ERC777Test190320";
    address[] private _defaultOperators = [owner]; //= ["dsdsdsd","asasasas"];
