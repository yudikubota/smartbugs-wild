...
contract LafiteToken {
    string public name;
    string public symbol;
    uint8 public decimals = 8;  // decimals å¯ä»¥æçå°æ°ç¹ä¸ªæ°ï¼æå°çä»£å¸åä½ã18 æ¯å»ºè®®çé»è®¤å¼
     ...
     * åå§åæé 
     */
    function LafiteToken(uint256 initialSupply, string tokenName, string tokenSymbol) public {
    ...
    /**
     * è®¾ç½®åè®¸ä¸ä¸ªå°åï¼åçº¦ï¼ä»¥æï¼åå»ºäº¤æèï¼çåä¹å¯æå¤è±è´¹çä»£å¸æ°ã
     *
