...
contract RollupProcessor is IRollupProcessor, Decoder, Initializable, AccessControl {
     ...
     * |Â 232          | 8           | pause flag, true if contract is paused, false otherwise
     */
    struct RollupState {
        IVerifier verifier;
        uint32 datasize;
    ...
    function verify(bytes calldata, uint256 public_inputs_hash) external view override returns (bool) {
        ...
        assembly {
             ...
             */
            {
                ...
                // r_0 = -(Ä + Î²sÌ_Ï1 + Î³)( bÌ + Î²sÌ_Ï2 + Î³)(cÌ + Î³)zÌ_Ï
            ...
            // 0x00 = SIGMA3_X_LOC,
            // 0x20 = SIGMA3_Y_LOC,
            // 0x40 = â(Ä + Î²sÌ_Ï1 + Î³)( bÌ + Î²sÌ_Ï2 + Î³)Î±Î²zÌ_Ï,
            // 0x60 = Z_X_LOC,
            // 0x80 = Z_Y_LOC,
            // 0xa0 = (Ä + Î²z + Î³)( bÌ + Î²k_1 z + Î³)(cÌ + Î²k_2 z + Î³)Î± + L_1(z)Î±^3 + u
                success := and(success, and(
                    ...
                    and(
                        ...
                        // [ACCUMULATOR_X_LOC, ACCUMULATOR_X_LOC + 0x40) = ((Ä + Î²z + Î³)( bÌ + Î²k_1 z + Î³)(cÌ + Î²k_2 z + Î³)Î± + L_1(z)Î±^3 + u)*[z]_1
                        staticcall(gas(), 7, 0x00, 0x60, ACCUMULATOR2_X_LOC, 0x40)
                        // [ACCUMULATOR2_X_LOC, ACCUMULATOR2_X_LOC + 0x40) = â(Ä + Î²sÌ_Ï1 + Î³)( bÌ + Î²sÌ_Ï2 + Î³)Î±Î²zÌ_Ï * [s_Ï3]_1
                    )
                ))
             ...
             */
            {
                ...
                let success := and(
                    staticcall(gas(), 6, ACCUMULATOR_X_LOC, 0x80, ACCUMULATOR_X_LOC, 0x40),
                    // [ACCUMULATOR_X_LOC, ACCUMULATOR_X_LOC + 0x40) = ((Ä + Î²z + Î³)( bÌ + Î²k_1 z + Î³)(cÌ + Î²k_2 z + Î³)Î± + L_1(z)Î±^3 + u)*[z]_1 â(Ä + Î²sÌ_Ï1 + Î³)( bÌ + Î²sÌ_Ï2 + Î³)Î±Î²zÌ_Ï * [s_Ï3]_1
                    staticcall(gas(), 7, 0x00, 0x60, ACCUMULATOR2_X_LOC, 0x40)
                    // [ACCUMULATOR2_X_LOC, ACCUMULATOR2_X_LOC + 0x40) = Ä * [q_L]_1
                )
