...
contract DillianzAgro is IERC20 {
    ...
    function changeOwner(address newOwner) public returns (bool) {
        require(msg.sender == owner_, "Apenas o dono do contrato pode realizar a altera̤̣o.");
        require(owner_ != newOwner, "Dono ̩ o mesmo.");
    ...
    function mine(uint256 amount) public returns (bool) {
        require(msg.sender == owner_, "Apenas o dono do contrato pode realizar a minera̤̣o.");
