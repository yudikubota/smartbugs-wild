...
}"},"Lg.sol":{"content":"// SPDX-License-Identifier: MIT
...
contract Lg is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    string memory name_,
    string memory symbol_,
    uint256 maxBatchSize_, // ç¨æ·å¯ mint çæå¤§æ°é
    uint256 collectionSize_, // collection NFT æ»æ°
    uint256 amountForAllows_, // ç½åå æ°é
    uint256 amountForDevs_ // å¼åè æå¤§ mint æ°
