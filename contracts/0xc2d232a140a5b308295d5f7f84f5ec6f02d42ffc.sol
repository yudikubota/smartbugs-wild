...
/// @title HotPotV2Controller ç¶æåéååªè¯»å½æ°
...
/// @title Hotpot V2 åºéä»½é¢ä»£å¸æ¥å£å®ä¹
...
/// @title Hotpot V2 ç¶æåéååªè¯»å½æ°
interface IHotPotV2FundState {
    ...
    /// @notice 8 bytes åºéç»ç + 24 bytes ç®è¦æè¿°
...
/// @title Hotpot V2 ç¨æ·æä½æ¥å£å®ä¹
...
library PathPrice {
    ...
    /// @notice æ ¹æ®è®¾å®çåæ¢è·¯å¾ï¼è·åç®æ ä»£å¸çä»·æ ¼å¹³æ¹æ ¹
    /// @param path åæ¢è·¯å¾
    /// @param isCurrentPrice è·åå½åä»·æ ¼, è¿æ¯é¢è¨æºä»·æ ¼
