...
contract TheMatrix is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Matrix Official", "TMO") {
    setHiddenMetadataUri("ipfs://QmNYdAvzTX687zCtq51ViwZwwDGHqfwFDSez4a6evzzCJ8/thematrix.json");
  }
