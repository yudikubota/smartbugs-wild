...
contract TidePool is ITidePool, IUniswapV3MintCallback, IUniswapV3SwapCallback, ERC20 {
    ...
    "contracts/libraries/FactoryValidator.sol": {
      "content": "//SPDX-License-Identifier: Unlicense
pragma solidity =0.7.6;
pragma abicoder v2;
...
"
    ...
    "contracts/interfaces/ITidePool.sol": {
      "content": "// SPDX-License-Identifier: GPL-2.0-or-later
...
interface ITidePool {
    ...
    "contracts/libraries/TidePoolMath.sol": {
      "content": "//SPDX-License-Identifier: Unlicense
pragma solidity =0.7.6;
pragma abicoder v2;
...
"
  ...
  "settings": {
    ...
    "libraries": {
      "contracts/libraries/PoolActions.sol": {
        "PoolActions": "0x20e21a4b605a3bf2b59ff69e144bdd2ad77c972f"
      },
      "contracts/libraries/TidePoolMath.sol": {
        "TidePoolMath": "0x7661d87b2750bcd7e67c8800e3a2251c9898ca16"
      },
      "contracts/libraries/FactoryValidator.sol": {
        "FactoryValidator": "0x53eaf5f52c3b769f45ea5474d4910bb37df75d1c"
      }
    }
  }
}}