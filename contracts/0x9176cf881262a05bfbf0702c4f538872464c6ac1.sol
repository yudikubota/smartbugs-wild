...
contract FIFAINU is ERC20, Ownable {
    ...
    constructor() ERC20("FIFA INU", "FIFA") {
    	...
    	marketingWallet = address(0x619DC0848a9c61Af814B6258bCd1E09e9B02F054); // set as marketing wallet
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
  	    require(_maxToken <= totalSupply() * 3 / 100, "Smax token cannot be lower than 3% total supply.");
