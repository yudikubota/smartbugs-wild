...
contract MergedPanda is ERC20, Ownable {
    ...
    constructor() ERC20("Merged Panda", "PETH") payable {
    	...
    	marketingWallet = address(0x6eb8eDab9DE20A37d0Cd1fb4cab7671c9FefFC44); // set as Marketing wallet
        devWallet = address(0xF030eb3e7Ed3216D7a4C67d804aB11E368e6D610); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x6eb8eDab9DE20A37d0Cd1fb4cab7671c9FefFC44, true);
        excludeFromFees(0x6eb8eDab9DE20A37d0Cd1fb4cab7671c9FefFC44, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x6eb8eDab9DE20A37d0Cd1fb4cab7671c9FefFC44, true);
        excludeFromMaxTransaction(0xF030eb3e7Ed3216D7a4C67d804aB11E368e6D610, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x6eb8eDab9DE20A37d0Cd1fb4cab7671c9FefFC44,
            block.timestamp
        );
    }
