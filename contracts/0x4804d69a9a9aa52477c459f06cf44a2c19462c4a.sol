...
contract APEMASYA is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x7F304eAD54FAbeCc7F947993b6a5727748b2887b));

    string private _name = "APE MASYA";
    string private _symbol = "APEMASYA";
