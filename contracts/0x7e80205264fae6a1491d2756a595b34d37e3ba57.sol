...
Snuffles Inu is a community based token on the ERC-20 network. 
The community holds and exchanges to gain access to rewards, 
collectibles, and platform utilities!

https://t.me/SnufflesInu
https://snufflesinu.com
https://twitter.com/SnufflesInu
...
contract SnufflesInu is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Snuffles Inu";
    string constant _symbol = "SNINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 5) / 1000;
    uint256 _maxSellTxAmount = (_totalSupply * 5) / 1000;
    ...
    uint256 sellBias = 400;
    uint256 feeDenominator = 1000;

    address payable public liquidityFeeReceiver = payable(0xe429FDf7a17Cc7b44F339e7861c898dCA9270Db4);
    address payable public marketingFeeReceiver = payable(0xe429FDf7a17Cc7b44F339e7861c898dCA9270Db4);
