...
contract VisionCoin {
    ...
    uint256 public limitedBlockHeight = 11603843;
    ...
    function changeLimitedBlockHeight(uint256 blockHeight) public ownerOnly(msg.sender) returns (bool success) {
        limitedBlockHeight = blockHeight;
        return true;
    }
