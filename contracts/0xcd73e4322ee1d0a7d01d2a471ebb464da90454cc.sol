...
/// @title PLAN-BEE IDDS Domain Data System ååæ°æ®ç³»ç»
/// @author Iwan Cao
/// @notice å¼æ¾ä½¿ç¨åçº¦ï¼ä»»ä½äººå¯ä»¥å­å¨èªå·±çæ°æ®
/// @dev æ¯ä¸ªdomainå¯ä»¥å­å¨ä¸ç»keyï¼æ¯ä¸ªkeyå­å¨ä¸ä¸ªbytesæ°æ®. é»è®¤çdomainæ¯å¬å¼çï¼ä»»ä½äººå¯è¯»ãå¦æéè¦ç§æåæ°æ®ï¼éæ©DATATYPE ä¸ºPRIVATEã
/// @dev æ°æ®çæ¥æèæè½æ´æ¹æ°æ®ï¼æ´æ¹ä¸ºbytes(0)æå³çå é¤è¿ä¸ªkey.
/// @dev æ°æ®é»è®¤æ¯msg.senderä½ä¸ºæ¥æèï¼å¦æéè¦ä¸ªäººè´¦æ·tx.originä½ä¸ºæ¥æèï¼è¯·éæ©DATATYPE ä¸ºPERSONAL
/// @custom:planbee è¿æ¯ä¸ä¸ªPLAN-BEEè®¡åè®¤è¯çåçº¦
