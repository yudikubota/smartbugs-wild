...
contract LIZS is Ownable{
    ...
    uint32[5] public totalVipCount = [0,0,0,0,0];   //æ¯ä¸ªçº§å«çVIPäººæ°

    uint256 public vipBuyPool;  //VIPä¹°å¥æ± 
    uint256 public vipBuyPoolOut; //ç®¡çåå·²æåçeth
    uint256 public stakePool;  //è´¨æ¼æ± 
    uint256 public stakeFee;  //éè´¨æ¼äº§çfee,å½ç®¡çå
    ...
    uint constant private vipExtraStakeRate = 10 ether; //æ¯çº§VIPé¢å¤éç®å
