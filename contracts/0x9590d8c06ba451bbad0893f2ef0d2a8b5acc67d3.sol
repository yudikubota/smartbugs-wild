...
Scorcher features:
ð¥ 3% to a true burn where the tokens are deducted from the supply creating a hyper-defaltionary token.
ð¥ 3% for auto LP to ensure an evergrowing Liquidity Pool.
ð¥ 3% to PyroBurn contract where it buys and burns Pyro.
ð¥ A 9% Jeet Killer tax at launch to help deter snipers.
*/
