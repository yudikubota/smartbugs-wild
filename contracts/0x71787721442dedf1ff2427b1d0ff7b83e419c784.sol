...
contract ELON1996 is Context,IERC20, Ownable{
 ...
 string private _symbol = "ELON1996";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x94d28413103C284165adC393dD506c83C309E95C);
 ...
 //Tokenomics related functions
  function ELON1996Day() public onlyOwner{
      require(block.timestamp > ELON1996Daycooldown, "You cant call ELON1996CoinDay more than once a day");
 ...
 function ELON1996CoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      ELON1996Daycooldown = block.timestamp + 86400;
 }
