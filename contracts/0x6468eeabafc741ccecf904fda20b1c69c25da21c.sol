...
interface DFEngine {
    ...
    function destroy(address _sender, uint _feeTokenIdx, uint _amount) external returns (bool);
}

interface DFStore {
    function getTokenMedian(address _tokenID) external view returns (address);
