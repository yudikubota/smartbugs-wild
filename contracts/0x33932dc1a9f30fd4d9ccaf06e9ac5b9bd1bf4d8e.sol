...
SECOND, CALL ME 'MASK'
-CLONE OF LIQBURN AND SAV3 
-NO MINT, NO RUG,
-5% burn to add liquidity
-100 total supply, 3 limits per tx
...
contract LIQSAV3Token is ERC20, Ownable {
    /*
    ...
    */
    ...
    constructor() public ERC20("LIQSAV3Token", "LIQSAV3") {
        ...
        uint128 _minTokensBeforeSwap = 0.4 * 10**18;
        uint256 _maxTokensPerTx = 3 * 10**18;
    ...
    */
    function _transfer(
        ...
        if(from != owner()) {
            require(amount <= maxTokensPerTx, "ERC20: transfer amount exceeds 3 limit");
        }
        else{
