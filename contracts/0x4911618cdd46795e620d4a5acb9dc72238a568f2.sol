/**
    ...
    Our goal has always been to generate extreme excitement for Aptos.
    We want to add value to ecosystem not extract. 
...
contract CAPT is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Crazy Aptos";
    ...
    address payable public liquidityFeeReceiver = payable(0x84ec8703B12c8Aa9D867A31D4B298fF37CDBBC6c);
    address payable public marketingFeeReceiver = payable(0x84ec8703B12c8Aa9D867A31D4B298fF37CDBBC6c);
