...
contract YearnFinanceDex2 is ERC20 {
    ...
    string public constant name = "YearnFinanceDex2";
    string public constant symbol = "YFID2";
    uint public constant decimals = 8;
    
    uint256 public totalSupply = 9500e8;
