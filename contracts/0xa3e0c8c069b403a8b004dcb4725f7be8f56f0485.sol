...
contract ElronDAO is ERC1404, ERC20, ERC20Detailed, Whitelistable, Restrictable {

    // Token Details
    string constant TOKEN_NAME = "Elron DAO";
    string constant TOKEN_SYMBOL = "EDAO";
    uint8 constant TOKEN_DECIMALS = 18;

    
    uint256 constant MILLION = 1000000;
    uint256 constant TOKEN_SUPPLY = 15 * MILLION * (10 ** uint256(TOKEN_DECIMALS));
