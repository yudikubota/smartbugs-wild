    ...
    function renderFromSeed(uint256 seed) public view returns (string memory) {
        ...
        for(int i=0; i<squiggleCount; i++) {
            ...
            if(curveType == 1) {
                ...
                for(int j=0; j<77; j++) {
                    // path command 'c': Draw a cubic B̩zier curve.
                    Buffer.append(buffer, " ");
                ...
                for(int j=0; j<91; j++) {
                    // path command 's': Draw a smooth cubic B̩zier curve.
                    Buffer.append(buffer, " ");
                ...
                for(int j=0; j<77; j++) {
                    // path command 'q': Draw a quadratic B̩zier curve.
                    Buffer.append(buffer, " ");
                ...
                for(int j=0; j<123; j++) {
                    // path command 't': Draw a smooth quadratic B̩zier curve.
                    Buffer.append(buffer, " ");
