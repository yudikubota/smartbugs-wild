...
| $$__  $$| $$| $$__  $$  /$$$$$$$  | $$    | $$$$$$$$|  $$$$$$ | $$  $$$$| $$__/      | $$   | $$$$$$$$| $$$$$$$$|  $$$$$$ 
| $$  | $$| $$| $$  | $$ /$$__  $$  | $$ /$$| $$_____/ \____  $$| $$\  $$$| $$         | $$   | $$_____/| $$_____/ \____  $$
| $$  | $$| $$| $$  | $$|  $$$$$$$  |  $$$$/|  $$$$$$$ /$$$$$$$/| $$ \  $$| $$         | $$   |  $$$$$$$|  $$$$$$$ /$$$$$$$/
|__/  |__/|__/|__/  |__/ \_______/   \___/   \_______/|_______/ |__/  \__/|__/         |__/    \_______/ \_______/|_______/ 
...
// File: contracts/AiHatesNFTees.sol
...
contract AiHatesNFTees is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function ownerMint(uint256 _mintAmount, address _addressTo) public onlyOwner {
    uint256 supply = totalSupply();
    require(supply + _mintAmount <= maxSupply, "Max supply exceeded!");
   for (uint256 i = 1; i <= _mintAmount; i++) {
