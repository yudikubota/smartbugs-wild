...
/**
* @title BLUEBAIKAL implementation based on StandardToken ERC-20 contract.
*
* @author Clark Jang
* @dev see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
*/
contract BLUEBAIKAL is ERC20, CustomToken, ExtendsOwnable {
    using SafeMath for uint256;

    // BLUEBAIKALSWAP í í° ê¸°ë³¸ ì ë³´
    string public constant name = "BLUEBAIKALSWAP";
    string public constant symbol = "LAKEtemp";
    uint256 public constant decimals = 18;

    /**
     * @dev fallback ì´ëë¦¬ìì´ ì ì¡ë  ê²½ì° Revert
     *
     */
    ...
    /**
     * @dev í í° ëë¦¬ ì ì¡ì ìí í¨ì
     *
     * @param _from í í°ì ê°ì§ê³  ìë ì§ê° ì£¼ì
     * @param _to í í°ì ì ì¡ë°ì ì§ê° ì£¼ì
     * @param _value ëë¦¬ ì ì¡í  í í° ìë
     * @return bool íìì í í° ëë¦¬ ì ì¡ ê¶í ì±ê³µ ì¬ë¶
     */
    ...
    /**
     * @dev BLUEBAIKAL í í° ì ì¡ í¨ì
     *
     * @param _to í í°ì ë°ì ì§ê° ì£¼ì
     * @param _value ì ì¡í  í í° ìë
     * @return bool íìì ì ì¡ ê²°ê³¼
     */
    ...
    /**
     * @dev BLUEBAIKAL í í° ì ì¡ê³¼ ë°ì´í°ë¥¼ í¨ê» ì¬ì©íë í¨ì
     *
     * @notice CustomToken ì¸í°íì´ì¤ íì©
     * @notice _to ì£¼ìê° ì»¨í¸ëí¸ì¸ ê²½ì°ë§ ì¬ì© ê°ë¥
     * @notice í í°ê³¼ ë°ì´í°ë¥¼ ë°ì¼ë ¤ë©´ í´ë¹ ì»¨í¸ëí¸ì receiveApproval í¨ì êµ¬í íì
     * @param _to í í°ì ì ì¡íê³  í¨ìë¥¼ ì¤íí  ì»¨í¸ëí¸ ì£¼ì
     * @param _value ì ì¡í  í í° ìë
     * @return bool íìì ì²ë¦¬ ê²°ê³¼
     */
    function approveAndCall(address _to, uint256 _value, bytes _data) public returns (bool) {
