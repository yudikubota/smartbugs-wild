...
Tales of Tate
There once was a Tate
Stealth launch so no website but will make one at 50k cap
Locked Liquidity
Renounced Ownership
If ny any chance we achieve 1 mill cap i'll publish a book named"There Once was a Tate"
...
contract TalesOfTate is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "There Once Was A Tate";//
    string private constant _symbol = unicode"Tales Of Tate";//
    ...
    address payable private _developmentAddress = payable(0x8ca6D074CcB1A70dFA95157D9E8A73a321D97F7d);//
    address payable private _marketingAddress = payable(0x8ca6D074CcB1A70dFA95157D9E8A73a321D97F7d);//
