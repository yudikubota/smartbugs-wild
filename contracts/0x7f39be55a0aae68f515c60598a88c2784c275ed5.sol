...
contract Starboys is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) { //ë¯¼í ê°ë¥í ìµë ê°¯ì ê²ì¦íë í¨ì
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) { //ë¯¼í ê°ê²© * ë¯¼í¸ ê°¯ì ë§í¼ ë³´ëëì§ ì²´í¬  msg.value** ë³´ë¸ ì¨ì´ 
