...
contract Khype is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Kawaii Hyperdrive";
    string private constant _symbol = "KHYPE";
    ...
    uint256 public rebalanceInterval = 44 minutes;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'Khype: The contract it self cannot be excluded');
        require(!_isExcluded[account], "Khype: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "Khype: Account is already included");
