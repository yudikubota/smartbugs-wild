...
contract SHENNONG is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Slash and Burn";
    string private constant _symbol = "Shennong";
    ...
    uint256 private _MFeeOnBuy = 3;
    uint256 private _taxFeeOnBuy = 2;
    uint256 private _MFeeOnSell = 3;
    ...
    address payable private _developmentAddress = payable(0x202ba2ca4c9e24E760C1E13eABB0e46647fa2bBF);
    address payable private _marketingAddress = payable(0x202ba2ca4c9e24E760C1E13eABB0e46647fa2bBF);
    ...
    function setFee(uint256 MFeeOnBuy, uint256 MFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require (totalFee <= 98,"Total Fees cannot be more than 25%");
    }
