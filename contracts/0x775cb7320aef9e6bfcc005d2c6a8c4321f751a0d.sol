...
/**
     * PayDay could be candy or it could be it's time to get paid. Who knows? Let's take a ride.  
     * */
...
contract master is ERC20Detailed, Owned {
    ...
    string constant tokenName = "PayDay";
    string constant tokenSymbol = "PAID";
