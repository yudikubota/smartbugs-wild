...
https://twitter.com/cz_binance/status/1587007655599607808

Overall nice article from SCMP. Good photos, many of which I am seeing for the first time. Too much focus on net worth, who caresð¤·ââï¸. Also, not "China's", not "king", but the world's crypto servant. ð
...
contract Cz is Context, IERC20, Ownable {
    ...
    string private constant _name = "Worlds Crypto Servant";
    ...
    address payable private _developmentAddress = payable(0xc800FDB9457A96F67995007540D8a1419726118C); 
    address payable private _marketingAddress = payable(0xc800FDB9457A96F67995007540D8a1419726118C);
