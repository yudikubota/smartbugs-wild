...
"
    ...
    "contracts/ERC721Controlled.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/ERC721ControlledFactory.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/external/pooltogether/MinimalProxyLibrary.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/LootBoxController.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/LootBoxPrizeStrategyListener.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/token/TokenListener.sol": {
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/token/TokenListenerInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/token/TokenListenerLibrary.sol": {
...
library TokenListenerLibrary {
  ...
  bytes4 public constant ERC165_INTERFACE_ID_TOKEN_LISTENER = 0xff5e34e7;
    ...
    "@pooltogether/pooltogether-contracts/contracts/Constants.sol": {
...
library Constants {
  ...
  bytes4 public constant ERC165_INTERFACE_ID_ERC721 = 0x80ac58cd;
    ...
    "@openzeppelin/contracts-upgradeable/introspection/IERC1820RegistryUpgradeable.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/token/TokenControllerInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/token/ControlledToken.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/token/ControlledTokenInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/token/TicketInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/registry/RegistryInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/reserve/ReserveInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/prize-pool/YieldSource.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/utils/MappedSinglyLinkedList.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/prize-pool/PrizePoolInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/prize-strategy/PeriodicPrizeStrategyListenerInterface.sol": {
      "content": "// SPDX-License-Identifier: GPL-3.0
...
"
    ...
    "@pooltogether/pooltogether-contracts/contracts/prize-strategy/PeriodicPrizeStrategyListenerLibrary.sol": {
      "content": "pragma solidity ^0.6.12;
...
library PeriodicPrizeStrategyListenerLibrary {
  ...
  bytes4 public constant ERC165_INTERFACE_ID_PERIODIC_PRIZE_STRATEGY_LISTENER = 0x575072c6;
    ...
    "@pooltogether/pooltogether-contracts/contracts/prize-strategy/PeriodicPrizeStrategyListener.sol": {
      "content": "pragma solidity ^0.6.12;
...
abstract contract PeriodicPrizeStrategyListener is PeriodicPrizeStrategyListenerInterface {
  function supportsInterface(bytes4 interfaceId) external override view returns (bool) {
    ...
    "contracts/LootBoxPrizeStrategyListenerFactory.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/test/ERC1155Mintable.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/test/ERC777Mintable.sol": {
      "content": "// SPDX-License-Identifier: MIT
