...
/*
 *Prime 3500, the loose encryption token, the number will only decrease, not increase!
 */
...
contract LooselyEncryptedToken is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Loosely Encrypted Token";
string constant tokenSymbol = "LYEDT";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 3500000000000000000000;
