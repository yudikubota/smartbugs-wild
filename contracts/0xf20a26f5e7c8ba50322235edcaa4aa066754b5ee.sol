...
contract SMILEToken is MintableToken, PausableToken, BurnableToken {
    string public name = "SMILE Token";
    string public symbol = "SML";
    uint8 public decimals = 18; 
    uint256 public  initialSupply = 70700000000 * (10 ** uint256(decimals));
    // Constructor
    constructor() public {
