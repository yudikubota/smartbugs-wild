...
contract PlayerBook is Governance {
    ...
    // the direct refer's reward rate  ç´æ¥æ¨èäººçå¥å±ç
    ...
    /**
    åæ°ç±»åï¼(string memory nameString, string memory affCode) //èªå·±çåå­ï¼éè¯·äººçåå­
è¯´æï¼å¦æéè¯·äººçåå­ä¸ºââæå³çæ²¡æéè¯·è
	æ¯ä¸æ¬¡æ³¨åæ¯éè¦æ¯ä»æç»­è´¹çï¼ã0ï¼99ï¼å·ç¨æ·æ¶å100 finneyï¼ã100ï¼199ï¼200 ï½
     */
    ...
    //æ¥è¯¢æä¸ªç¨æ·çidï¼éè¯·èidï¼éè¯·æ°é
