...
Frustration from seeing shitcoins get hyped because a dev wrote something about the space needed a âresetâ or how thereâs a âresurgenceâ coming at the top of the contract. Whoopty f**king doo!

Theyâd promise buybacks but go to sleep on their communities and that really pisses me off. 

People invest their money when they are inspired and thereâs nothing worse than watching a group of inspired investors lose hope so quickly. 

What is more frustrating than ever is these devs donât have a creative bone in their bodies. Perhaps the truth is, they are just incapable of writing unique functions and just fork the latest shit to try and make a buck at the expense of degens. 

Well, frustration can breed change, and thatâs exactly what $BUILD attempts to do. 

Iâm writing in a function no one has ever seen before. A function that rewards investors who join forces to create buy walls and help send this token to new heights every day. 

As devs know, loops arenât possible in solidity, so Iâve created a counter instead that will count the number of consecutive buys and record the buyerâs wallets who form a flow of consecutive buys - AKA a buy wall. 

How will it work? 

The contract will accumulate ETH with every buy and sell. 

This ETH will become âactivatedâ whenever there is a buy wall of 10 buys. At the same time, the sell tax will snap to 21% to ensure that anyone who breaks the buy wall will get penalised for being short-sighted. In fact, the sell tax will only reset back to 5% once another buy comes in. 
...
This contract was written for those who understand that the tokens that fly to huge market caps have all got one thing in common - thereâs an army of people all joining forces to help get it there. 
...
library SafeMath {
    ...
    "contracts/Gr33nDividendTracker.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.11;
