...
// ä»¥ä¸æ¯å¬å±å¤æ­ååºæ¬æ¹æ³
    ...
    bool public status = true;// å¤æ­è¯¥åçº¦ç¶æ
    ...
    mapping (address => uint) whitelist;// ç½åååè¡¨
...
// ä»¥ä¸æ¯æäºå¬å±æ¨¡å
    ...
    // éè¿address å key å¤æ­æ¯å¦æè¯¥æäºçºªå½
