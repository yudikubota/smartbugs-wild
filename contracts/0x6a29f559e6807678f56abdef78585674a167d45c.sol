/*
LEGEND OF SEA (LOS) $SCYLLA

Liquidity Pool
2% tax of every transaction goes to the liquidity pool.
Credit card icon

Marketing
6% tax of every transaction goes to the marketing wallet for development, media expansion and CEX listings.

https://t.me/LosScyllaETH
*/
...
contract Scylla is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x04805D7bcac0465dbaeA25FaE1Fcc99059946512));

    string private _name = "Legend Of Sea";
    string private _symbol = "Scylla";
