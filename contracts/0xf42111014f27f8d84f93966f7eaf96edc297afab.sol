...
library FullMath {
    /// @notice Calculates floor(aÃbÃ·denominator) with full precision - throws if result overflows an uint256 or denominator == 0.
    ...
    /// @notice Calculates ceil(aÃbÃ·denominator) with full precision - throws if result overflows an uint256 or denominator == 0.
    /// @param a The multiplicand.
    /// @param b The multiplier.
    /// @param denominator The divisor.
    /// @return result The 256-bit result.
