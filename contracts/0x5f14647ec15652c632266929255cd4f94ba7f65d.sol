...
}"},"DominoERC20.sol":{"content":"// SPDX-License-Identifier: MIT
pragma solidity >=0.8.1;
...
// ===== End: DAO Support (Compound-like voting delegation) ====="},"DomiSale.sol":{"content":"pragma solidity 0.8.1;
...
}"},"ERC20Receiver.sol":{"content":"// SPDX-License-Identifier: MIT
pragma solidity 0.8.1;
