 ...
 * éä»·ååçº¦:
    1. æ¯æéä»·ä¹°å
    2. æ¯æéä»·åå
    3. æ¯æç¨æ·å§æè®¢åï¼å¹¶æerc20è½¬è¿æ¥
    4. æ¯ææç®¡è´¦æ·å¸®å¿æå
...
contract TitanSwapV1LimitOrder is ITitanSwapV1LimitOrder {
    ...
    struct Order {
        bool exist;
        address pair;
        address payable user; // ç¨æ·å°å
        address sellToken;
        // uint direct; // 0 æ 1,é»è®¤æ ¹æ®pairçtokenå°åååºæ,0- token0, token1 1- token1 token0
        uint amountIn;
        uint amountOut;
        uint ethValue;
