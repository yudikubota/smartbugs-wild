/**
     Kiyomi-Kira Suzume is a decentralized token on
    ERC20 that avoids heavy price fluctuations 
    caused by farming and lp acquisition. Instead, 
    Kiyomi-Kira Suzume provides 2% auto-reflections in
    their primary token to holders.

    https://t.me/KiyomiKiraSuzumeERC20

    https://www.kiyomikirasuzume.com/

    https://twitter.com/KiyomiKirasuzum
...
pragma solidity ^0.6.12;
    ...
    contract KiyomiKiraSuzume is Context, IERC20, Ownable {
        ...
        string private _name = 'Kiyomi-Kira Suzume';
        string private _symbol = 'SUZUME';
