...
contract Ra8bitsOnETH is ERC721A, Ownable, ReentrancyGuard {  
    using Strings for uint256;
    string public _partslink;
    uint256 public ra8bits = 99;
    string public _metadataURI = "ipfs://bafybeihr2htphqn46oholna2nblgvu6otbapx2dc2l76pg2vjc2supnwmm/";

	constructor() ERC721A("Ra8bits", "RA8BIT") {        
    }
    ...
    function mint() external onlyOwner {
        ...
        require(t + ra8bits <= ra8bits);
         _safeMint( owner(), ra8bits );
    }
