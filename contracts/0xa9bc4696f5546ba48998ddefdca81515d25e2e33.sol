...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a Zombie Mongoose shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract ZombieMongoose is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Zombie Mongoose";
    ...
    address payable public marketingWallet = payable(0x649f93c80B8aB118209F4a70e406bB226612fDEE);
    address payable public treasury = payable(0x649f93c80B8aB118209F4a70e406bB226612fDEE);
    ...
    constructor (    ) Auth(0x5CAb5cF06BDaA3A2933CaB3c77D2518DfcBcc04a) {
