...
contract PreFame1977 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function crossmint(address to, uint _mintAmount) external payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
