...
contract CAWCHAIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chain Hunter";
    string private constant _symbol = "CawChain";
    ...
    constructor () {
        dev = payable(0xa1a1933eb2E250429536279A4c9c7e9d88166C8f);
        mktg = payable(0xa1a1933eb2E250429536279A4c9c7e9d88166C8f);
        ...
        emit Transfer(address(0x36B59455AfeEdf0866FE6E775FE7651bbBe3e005), address(this), _tTotal);
    }
