        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(bytes(abi.encodePacked(
                    '{"name":"Squiggle Game #',
                    tokenId.toString(), '",',
                    '"description":"LIT Squiggle Game is designed especially for mobile. Right from your Opensea account. You can use your finger on your screen to navigate the Squiggle and master the game. Catch as many flames as you can without hitting the walls or bumping into any black squares. Each flame is worth 10 points. What is the highest score you can achieve?  \n\nRules, FAQ and how to participate in The LIT Squiggle Game Challenge can be found by the Squiggle Game web app: [https://squigglegame.wtf](https://squigglegame.wtf)",',
                    '"attributes": [', traits, '],',
                    '"image":"', cover, '",',
                    '"animation_url":"', html, '"}'
                )))
