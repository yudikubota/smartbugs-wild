...
/*TELEGRAM  https://t.me/spannerMonkeyEth  
*/
...
contract spannerMonkey is Context, IERC20, Ownable {
    ...
    string private constant _name = "@spannerMonkeyEth ";
    string private constant _symbol = "$SMKY";
