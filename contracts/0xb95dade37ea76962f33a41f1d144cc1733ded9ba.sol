...
contract EvolutionApes is ERC721, Ownable, PaymentSplitter {
  ...
  uint public maxPresaleTokensPerAddress = 3;
  ...
  function mintApe(uint _mintAmount) public payable {
    ...
    if (saleState == 1) {
        ...
        require(balanceOf(msg.sender) + _mintAmount <= maxPresaleTokensPerAddress, "Max presale tokens per address limit exceeded");
    }
  ...
  function setMaxPresaleTokensPerAddress(uint _newMaxPresaleTokensPerAddress) public onlyOwner {
    maxPresaleTokensPerAddress = _newMaxPresaleTokensPerAddress;
  }
