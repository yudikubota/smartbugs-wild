...
contract Airdrop is Ownable {
    ...
    * @param _tokenAddress address addresses to airdrop
    */
    function doAirdrop(uint256 [] calldata tokenIds, uint256 [] calldata startTimestamps, address _tokenAddress) external {
        
        require(_tokenAddress == msg.sender, "this is not your NFT owner!");
