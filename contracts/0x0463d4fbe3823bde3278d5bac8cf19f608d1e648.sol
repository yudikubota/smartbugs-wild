 ...
 contract Market is Ownable {
  ...
  function getCirculatingEth() public view virtual returns(uint krkAmount) {
   ...
   function getPrice(uint x) private pure returns(uint retPrice) {
     ...
     //stage 10
     //linear equation: y = 5.8579Ã10^-6 x - 19.2895
     ...
     //stage 9
     //linear equation: y = 3.8579Ã10^-6 x - 10.2895
     ...
     //stage 8
     //linear equation: y = 2.85792Ã10^-6 x - 6.28958
     ...
     //stage 7
     //linear equation: y = 2.19125Ã10^-6 x - 3.95625
     ...
     //stage 6
     //linear equation: y = 1.69125Ã10^-6 x - 2.45625
     ...
     //stage 5
     //linear equation: y = 1.29125Ã10^-6 x - 1.45625
     ...
     //stage 4
     //linear equation: y = 9.57917Ã10^-7 x - 0.789583
     ...
     //stage 3
     //linear equation: y = 6.72202Ã10^-7 x - 0.361011
     ...
     //stage 2
     //linear equation: y = 4.22202Ã10^-7 x - 0.111011
     ...
     //stage 1
     //linear equation: y = 1.9998Ã10^-7 x + 0.0001
