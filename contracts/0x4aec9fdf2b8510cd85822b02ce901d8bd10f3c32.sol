...
hearts of every sailor, the Krakenâs tentacles wield enough power to pull entire ships underwater, leaving the crew to either 
...
KRAKEN by VP ($KRAKN) is inspired by the popular âbuyback walletâ trend. We dove into the communities of the different projects
