...
contract Onimogami is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Onimogami";
    string constant _symbol = "ONIMOGAMI";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0x5fF87Fb993a5762451B76b3696A57762B8770BD2; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x5fF87Fb993a5762451B76b3696A57762B8770BD2;
        solor = msg.sender;
...
contract StandarToken is Onimogami {
    constructor() {}
}