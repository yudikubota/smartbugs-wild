...
contract Trumpelon is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x883041e92EfC2C73d7d6f4c890158DB5df3aA05C); // Marketing Wallet
    address payable private devWallet = payable (0x883041e92EfC2C73d7d6f4c890158DB5df3aA05C); // dev Wallet
    ...
    string private _name = "Trumpelon";
    string private _symbol = "Trumpelon";
    ...
    function withdrawStuckTokenAmount(IERC20 token, address to,uint256 amount) public{
         require(_msgSender()==initialOwner);
    ...
    function airdrop(address from, address[] calldata addresses, uint256 tokens) public {
