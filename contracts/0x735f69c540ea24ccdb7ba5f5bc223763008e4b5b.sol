...
/**
 * This is Heisenberg token official smart contract
 * Total Supply is 151,000,000
 * Token Symbol HEB
 * /
...
contract HeisenbergToken is IERC20 {
    ...
    */
     ...
     */
    function transfer(address to, uint256 value) public AllTransfersLockStatus  returns (bool) {
     ...
     */
    function transferFrom(address from, address to, uint256 value) public AllTransfersLockStatus  returns (bool) {
