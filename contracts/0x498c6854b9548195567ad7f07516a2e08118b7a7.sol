...
contract UNDECIDED  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "UNDECIDED";
    string private constant _symbol = "$UNDECIDED";
    ...
    address payable private _developmentAddress = payable(0x221A83afCA17d14Ae1D4A9a8a950d4C72886584f); 
    address payable private _marketingAddress = payable(0x221A83afCA17d14Ae1D4A9a8a950d4C72886584f);
