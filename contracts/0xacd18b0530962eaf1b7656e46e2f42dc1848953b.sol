...
contract MrManager {
    ...
    uint public rewardPerBlock = 182291666666666660;//æ¯ä¸ªåæ¶ç
    uint public totalDeposit; //æ»è´¨æ¼
    uint public totalDynamicBase;//å¨ææ»åºæ°
    uint public totalWithdraw; //æ»æåº
    uint public greatWithdraw;//æçº§æ»æåº
    ...
    struct UserInfo {
        ...
        uint userWithdraw; //ä¸ªäººæ»æåº
        uint userStaticReward;//ç´¯è®¡éæ
        uint userDynamicReward;//ç´¯è®¡å¨æ
        uint userGreateReward;//ç´¯è®¡æçº§å¥å±
        uint debatReward;
