...
// Main Contract Logic 
// --------------------------------------------------------------
contract Mulhazor is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Mulhazor";
    string private _symbol = "MULHAZOR";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xfA63767b896E8E030C37cA8169Fe58DDBC4684dA);
    address payable public operationsWallet =  payable(0xfA63767b896E8E030C37cA8169Fe58DDBC4684dA);
