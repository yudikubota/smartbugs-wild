...
â
    To revive the great bull run, the rivalry had to be culminated and the two needed to unite as one. A powerful force of the mixed communities emerged termed as the $OOO. OneOfOne is the new wave that degenerates look upto as the last hope. Just like the Ying and Yang which combined to form one of the most significant symbol in the Asian community, with the unity comes our strength. Like a circle , our ticker comes in the shape of three Oâs. The perfect shape exists since we have no corners or end to our mission. 
    â
