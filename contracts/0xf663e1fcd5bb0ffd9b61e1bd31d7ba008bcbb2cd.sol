...
// specified above (the âArtworkâ).
// 
// References to âyouâ herein mean the legal owner of the digital non-fungible token (âNFTâ)
// minted as the Artwork, as recorded on the applicable blockchain. References to âusâ herein mean
// the Artist LUCIA DIAZ. References to the âArtworkâ herein mean the NFT, the creative and
...
// entitled to exercise the following rights with respect to the Artwork (the âOwnership
// Rightsâ):
...
//         Artwork (the âImageryâ) in both digital media (e.g., online) and physical media (e.g.,
...
//         âQualifying Display Deviceâ means a video monitor, projector, or other physical
...
//         the Artistâs name LUCIA DIAZ and the Artistâs LUCIA DIAZ IP Rights (as defined below) to
...
//      g. Use of the Artistâs LUCIA DIAZ IP Rights for any purpose other than as reasonably
//         required for exercise of the Ownership Rights, such as, without limitation, use of the
//         Artistâs name LUCIA DIAZ for endorsement, advertising, trademark, or other
//         commercial purposes.
// 
// 6. Artistâs LUCIA DIAZ Intellectual Property Rights. Subject to your Ownership Rights
...
// (collectively, the âArtistâs LUCIA DIAZ IP Rightsâ), including, without limitation: (i) the
...
// or off the blockchain; (iv) the title of the Artwork; and (v) the Artistâs name LUCIA DIAZ,
// signature, likeness, and other personally identifying indicia. The Artistâs LUCIA DIAZ IP
...
// may have, or claim to have, in any item falling within the definition of the Artistâs LUCIA
...
// Artistâs LUCIA DIAZ customary artistic and professional purposes (including, without
// limitation, use in books, publications, materials, websites, social media, and exhibitions
// dealing with the Artistâs LUCIA DIAZ creative work, and licensing for merchandising,
...
// other NFTs), and to register any or all of the Artistâs LUCIA DIAZ IP Rights (including,
...
// âburn,â or otherwise cease to own the Artwork for any reason, your rights to exercise any of
...
// will thereafter be entitled to exercise the Ownership Rights, and references to âyouâ herein
...
// NFT are provided strictly âas is.â The Artist LUCIA DIAZ does not make any other
...
// THE ARTWORK AND THE NFT ARE PROVIDED ENTIRELY ON AN âAS ISâ AND
// âAS AVAILABLEâ BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY
...
//         factors and forces that are not within our, the Artistâs LUCIA DIAZ control.
...
//      â¢ Unauthorized third-party activities and actions, such as hacking, exploits, introduction of
...
//      â¢ Weaknesses in security, blockchain malfunctions, or other technical errors.
//      â¢ Telecommunications or Internet failures.
//      â¢ Any protocol change or hard fork in the blockchain on which the Artwork is recorded.
//      â¢ Errors by you (such as forgotten passwords, lost private keys, or mistyped addresses).
//      â¢ Errors by us (such as incorrectly constructed transactions or incorrectly programmed
//        NFTs). 
//      â¢ Unfavorable regulatory determinations or actions, or newly implemented laws or
//        regulations, in any jurisdiction.
//      â¢ Taxation of NFTs or cryptocurrencies, the uncertainty of the tax treatment of NFT or
//        cryptocurrency transactions, and any changes in applicable tax laws, in any jurisdiction.
//      â¢ Your inability to access, transfer, sell, or use the Artwork for any reason.
//      â¢ Personal information disclosures or breaches.
//      â¢ Total or partial loss of value of the Artwork due to the inherent price volatility of digital
...
//      the Artistâs liability if it would be unlawful to do so, such as any liability that cannot legally
...
// successors, licensees, and assigns (jointly and severally, the âIndemnified Partiesâ) from and
...
// reasonable attorneysâ fees and legal, court, settlement, and other related costs) of any kind or
...
// partyâs own costs in connection with the arbitration. Judgment upon any arbitral award may
...
// 
// 15. Artistâs LUCIA DIAZ Successor. After the Artistâs LUCIA DIAZ lifetime, the rights granted
// to the Artist LUCIA DIAZ herein will be exercised by the successor owner of the Artistâs
// LUCIA DIAZ IP Rights, which owner will be deemed the Artistâs LUCIA DIAZ successor
