/**
Hydra Dragon Protocol (Draco hydra) uniquely amongst the dragons, reproduces by splitting heads off from its body. This only happens after the Hydra is several hundred years old. The hydra is a multiheaded dragon, with anywhere between 3 to 7 heads recorded, but there are rumors of them having many more. It is the only dragon that reproduces by splitting its head. It is also one of the only dragons with only two legs and two useless wings.

ð²Telegram: https://t.me/HydraDragonProtocol
ð¢Website: http://hydradragonprotocol.com/
ðMedium: https://medium.com/@dragonhydra572
ð¤Twitter: https://twitter.com/ProtocolHydra
...
contract HYDRAGON   is Context, IERC20, Ownable {
    ...
    string private constant _name = "HYDRA DRAGON PROTOCOL";
    ...
    address payable private _developmentAddress = payable(0x595C16fd21aBC4fa20AC6a577F386AC16726Ad25); 
    address payable private _marketingAddress = payable(0x595C16fd21aBC4fa20AC6a577F386AC16726Ad25);
