...
contract BORINGPROTOCOL  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Boring Protocol";
    string private constant _symbol = "PROBORING";
    ...
    address payable private _developmentAddress = payable(0xEf8A7F5c8C419fC745eDA71f41fbeD8590baBe9d); 
    address payable private _marketingAddress = payable(0xEf8A7F5c8C419fC745eDA71f41fbeD8590baBe9d);
