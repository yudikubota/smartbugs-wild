{{
  "language": "Solidity",
  "sources": {
    "contracts/ERC721StakingPoolFactory.sol": {
...
"
    ...
    "contracts/ERC721StakingPool.sol": {
      "content": "// SPDX-License-Identifier: AGPL-3.0
...
"
    ...
    "contracts/lib/ClonesWithCallData.sol": {
      "content": "// SPDX-License-Identifier: MIT
    ...
    function cloneWithCallDataProvision(
        ...
        unchecked {
            ...
            assembly {
                ...
                // 61 runtime  | PUSH2 runtime (r)     | r 0                     | â
                mstore(
                    ptr,
                ...
                // creation size = 0b
                // 80          | DUP1                  | r r 0                   | â
                // 60 creation | PUSH1 creation (c)    | c r r 0                 | â
                // 3d          | RETURNDATASIZE        | 0 c r r 0               | â
                ...
                // 36          | CALLDATASIZE          | cds                     | â
                // 3d          | RETURNDATASIZE        | 0 cds                   | â
                // 3d          | RETURNDATASIZE        | 0 0 cds                 | â
                // 37          | CALLDATACOPY          | â                       | [0, cds] = calldata
                ...
                // 73 addr     | PUSH20 0x123â¦         | addr 0 cds 0 0 0        | [0, cds] = calldata
                mstore(
                    add(ptr, 0x1d),
