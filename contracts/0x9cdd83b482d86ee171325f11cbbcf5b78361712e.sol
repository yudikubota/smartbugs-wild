...
\_   _____//  |_|  |__   ___________   ____  __ __  _____\______   \____ /   _____/
 |    __)_\   __\  |  \_/ __ \_  __ \_/ __ \|  |  \/     \|     ___/  _ \_____  \ 
 |        \|  | |   Y  \  ___/|  | \/\  ___/|  |  /  Y Y  \    |  (  <_> )        \
/_______  /|__| |___|  /\___  >__|    \___  >____/|__|_|  /____|   \____/_______  /
        \/           \/     \/            \/            \/                      \/ 


Telegram: https://t.me/EthereumPoSOfficial
Website : https://EthereumPoS.cc
Twitter : https://twitter.com/EthereumPoS_tw
*/
...
contract EthereumPos is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("EthereumPoS", "EPoS") {
        ...
        excludeFromFees(0xbcf48f4dfb1e8eaC8Ae1b0C0AAEcC83A90393F44, true);
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool) {
  	    require(newAmount >= totalSupply() * 1 / 1000000000000, "Swap amount cannot be lower than 0.0000000001% total supply.");
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellBurnFee + sellDevFee;
        require(sellBurnFee.div(10) + sellDevFee.div(10) <= 8, "Must keep fees at 8% or less");
    }
