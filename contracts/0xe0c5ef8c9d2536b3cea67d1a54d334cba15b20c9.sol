...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xed499F83b612b65e38406C057847a929B0AC22c5];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xed499F83b612b65e38406C057847a929B0AC22c5;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 312) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPqd3MK8js67BhJ44YXpUJN4o3R55vupg4UsQQUyw8LWh/";
...
// File: contracts/ConceptsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ConceptsContract is RamppERC721A {
    constructor() RamppERC721A("Concepts", "Concept"){}
}
