...
contract WeThem is ERC721Collection, ERC721Presale, ERC721Sale {
    ...
    "/contracts/mixins/Whitelistable.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0 <0.9.0;
...
abstract contract Whitelistable is Ownable {
    ...
    "/contracts/mixins/WalletLimiter.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0 <0.9.0;
...
abstract contract WalletLimiter is Ownable {
    ...
    "/contracts/mixins/TXLimiter.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0 <0.9.0;
...
abstract contract TXLimiter is Ownable {
    ...
    "/contracts/mixins/ERC721Sale.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0 <0.9.0;
...
abstract contract ERC721Sale is Ownable, ERC721Collection, TXLimiter, WalletLimiter {
    ...
    "/contracts/mixins/ERC721Presale.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0 <0.9.0;
...
abstract contract ERC721Presale is Ownable, ERC721Collection, Whitelistable, TXLimiter, WalletLimiter {
    ...
    "/contracts/mixins/ERC721Collection.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0 <0.9.0;
