...
"},"Walkingmutant.sol":{"content":"// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

import "./ERC721A.sol";

contract WalkingMutant is ERC721A {

    constructor(string memory baseURI) ERC721A("Walking Mutant", "Walking") {
        setBaseURI(baseURI);
    }
