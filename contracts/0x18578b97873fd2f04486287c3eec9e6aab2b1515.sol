...
contract YieldTime is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Yield Time", "YIELD TIME", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xCbbfdCF0F0aA34762aA69A1aA18ab95866fF5D2e;
        treasuryReceiver = 0xE3CdD74129e4830bF624aA1DADa5EeC0F3A78a78; 
        RFVFundReceiver = 0x8D7E29FbfAe195315451f4216C3e592c1c01417b;
        firePit = DEAD;
