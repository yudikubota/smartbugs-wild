...
UMF is the official ERC-20 Token for "Ukrainian Memes Forces" meme page on twitter.
...
contract UMF is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Ukrainian Memes Forces";
    string public _symbol= "UMF";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x98672AC15893b30eF1034D674aE13AA2B274D6e6);
