...
Taxï¼6% (5% Tx tax 1% reflection in first 2 hours)
4%  (3% Tx tax 1% reflection )
Max Tx:2%
*/
...
contract Hachimaki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hachimaki";
    string private constant _symbol = "HACHIMAKI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x7B5e6C6A300Ff5DB2a239937B3dFcBAbE8147f8e);
        _feeAddrWallet2 = payable(0x7B5e6C6A300Ff5DB2a239937B3dFcBAbE8147f8e);
