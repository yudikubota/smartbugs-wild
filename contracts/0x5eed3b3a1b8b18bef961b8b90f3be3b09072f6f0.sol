...
Vitalik tweets is the new meta and our team has all the needed skills to send this. 

TG link will be sent via etherscan.
...
contract TALKY is ERC20, Ownable {
    ...
    string constant _name = "Talky Protocol";
    string constant _symbol = "TALKY";
