...
Website: https://www.babyxenapes.com/
Twitter: https://twitter.com/BabyXenApes
TG: https://t.me/BabyXenApes
*/
...
contract BABYXEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby XenApes";
    string private constant _symbol = "BABYXEN";
    ...
    function sendETHToFee(uint256 amount) private {
        _feeAddrWallet1.transfer(amount.mul(65).div(100));
        _feeAddrWallet2.transfer(amount.mul(35).div(100));
    }
