...
contract  DogeShiba is Context, IERC20, Ownable {
    ...
    string private _symbol = "DogeShiba";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xBdddbcdB485d2cE328D46740FD37cB743731D20b));
        marketWall = payable(address(0xBdddbcdB485d2cE328D46740FD37cB743731D20b));
