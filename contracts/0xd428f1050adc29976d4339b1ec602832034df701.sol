...
contract MaidCafe is IMaidCafe, ERC20("Maid Cafe", "$OMU"), Ownable {
    ...
    // Enter the Maid Caf̩. Pay some $MAIDs. Earn some shares.
    // Locks $MAID and mints $OMU (Omurice)
    function enter(uint256 _amount) public override {
        // Gets the amount of $MAID locked in the Maid Caf̩
        ...
        // Lock the $MAID in the Maid Caf̩
    ...
    // Leave the Maid Caf̩. Claim back your $MAIDs.
