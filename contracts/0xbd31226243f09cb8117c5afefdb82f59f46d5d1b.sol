...
contract Metadata {
    ...
    constructor(BokkyPooBahsDateTimeContract d) {
        ...
        MAJOR_CHORDS[4] = unicode'Maj7 â¯11';
        MAJOR_CHORDS[5] = unicode'7';

        JAZZ_MINOR_CHORDS[1] = unicode'm (Maj7)';
        JAZZ_MINOR_CHORDS[2] = unicode'sus7';
        JAZZ_MINOR_CHORDS[4] = unicode'7 â¯11';
        JAZZ_MINOR_CHORDS[5] = unicode'7 â­13';

        DIMINISHED_CHORDS[1] = unicode'7 â­9';
        DIMINISHED_CHORDS[2] = unicode'dim7';
        DIMINISHED_CHORDS[4] = unicode'dim7';
        DIMINISHED_CHORDS[5] = unicode'7 â­9';
...
library Encoding {
    ...
    "/contracts/DegenFetcherInterface.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.7;
