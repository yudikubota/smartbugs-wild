...
contract FUCKBURN is Context, IERC20, ERC20Ownable {
    ...
    string private constant _name = "FUCKBURN";
    string private constant _symbol = "FUCKBURN";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x9b01a78A81fd21dE6936C73734aEB7589201B579);
        DevWallet = payable(0x78364462e80c040C734589f0243141b34b9E3a51);
