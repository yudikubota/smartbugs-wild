...
contract Fund {
    ...
    constructor() public {
        ...
        percentages[0xc6B151C262AC32F02442d2C0C29DFD9B37F08C1d] = 1000;  // ÐÐ¾ÑÐµÐ»ÐµÐº B 10%
        percentages[0xA0D5b453f0A516a9E4D7C00EEa4577EA0b732740] = 500;   // ÐÐ¾ÑÐµÐ»ÐµÐº Ð 5%
...
contract BlagaDaru {
    ...
    constructor() public {
        ...
        blago = address(0xc6B151C262AC32F02442d2C0C29DFD9B37F08C1d);        // ÐÐ¾ÑÐµÐ»ÐµÐº B 10%
        walletK = address(0xA0D5b453f0A516a9E4D7C00EEa4577EA0b732740);      // ÐÐ¾ÑÐµÐ»ÐµÐº Ð 5%
        ...
        list[44] = 0xc6B151C262AC32F02442d2C0C29DFD9B37F08C1d;   // ÐÐ¾ÑÐµÐ»ÐµÐº B 10%
        list[45] = 0xA0D5b453f0A516a9E4D7C00EEa4577EA0b732740;   // ÐÐ¾ÑÐµÐ»ÐµÐº Ð 5%
