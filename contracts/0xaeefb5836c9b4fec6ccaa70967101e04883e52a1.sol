...
contract StandardToken is Token {
    ...
    //ææè´¦æ·_spenderå¯ä»¥ä»æ¶æ¯åéèè´¦æ·è½¬åºæ°éä¸º_valueçtoken
    function approve(address _spender, uint256 _value) returns (bool success)   
    {
...
contract MWTToken is StandardToken {
    ...
    uint8 public decimals;                //æå¤çå°æ°ä½æ°How many decimals to show. ie. There could 1000 base units with 3 decimals. Meaning 0.980 SBX = 980 base units. It's like comparing 1 wei to 1 ether.
    ...
    /* åæè½¬åºå¹¶è°ç¨æ¥æ¶åçº¦ï¼æ ¹æ®èªå·±éæ±å®ç°ï¼ */
