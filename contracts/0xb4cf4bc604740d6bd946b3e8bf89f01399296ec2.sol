...
"
    ...
    "@solv/solv-vnft-core/contracts/VNFTCore.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
abstract contract VNFTCore is IVNFT, ERC721Upgradeable {
    ...
    function _transferUnitsFrom(address from_, address to_, uint256 tokenId_,
        ...
        //approve allåå¯ä¸éè¦approve units
...
interface IVNFTReceiver {
    ...
    "@solv/solv-vnft-core/contracts/library/AssetLibrary.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
//@title èµäº§ç¸å³ç»æåé»è¾åº
library AssetLibrary {
    using SafeMath for uint256;

    struct Asset {
        uint256 slot; //æ è¯èµäº§çåç±»
        uint256 units; //èµäº§ä»½æ°
        bool isValid; //æ¯å¦ææ
    }

    //@notice å¢å Vaultçä»½é¢
    //@dev
    //@param self éè¦å¢å ä»½é¢çVaultçå¼ç¨
    //@param slot
    ...
    "@solv/solver/contracts/interface/ISolver.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
"
    ...
    "contracts/interface/IICToken.sol": {
      "content": "// SPDX-License-Identifier: MIT
