...
contract TheCheetahsNft is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xfCAd9E86DD7Eb9222F410558b062F2d9b6d5E938));

    string private _name = "TheCheetahsNft";
    string private _symbol = "Cheetahs";
