 ...
 * `ERC20` functions.
 */
contract DEFI_BOT is ERC20, ERC20Detailed, ERC20Burnable, ERC20Mintable, ERC20Pausable {

    string private constant NAME = "DEFI BOT"; 
    string private constant SYMBOL = "DBOT"; 
