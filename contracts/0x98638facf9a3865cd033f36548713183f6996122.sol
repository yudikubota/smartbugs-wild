...
def exchange(i: uint256, j: uint256, dx: uint256, min_dy: uint256,
    ...
    """
    return self._exchange(msg.sender, msg.value, i, j, dx, min_dy, use_eth, receiver, ZERO_ADDRESS, b'    ')
...
def exchange_underlying(i: uint256, j: uint256, dx: uint256, min_dy: uint256,
    ...
    Exchange using ETH
    """
    return self._exchange(msg.sender, msg.value, i, j, dx, min_dy, True, receiver, ZERO_ADDRESS, b'    ')
...
def exchange_extended(i: uint256, j: uint256, dx: uint256, min_dy: uint256,
    ...
    assert cb != b'    '  # dev: No callback specified
