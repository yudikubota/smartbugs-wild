...
contract GhostFrens is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTvdhSS6DM74dRUYaH36VG6bpYn48F4ETNUyXEvoVRMic";
    ...
    constructor(
    ) ERC721A("Ghost Frens", "GHOST", 100, maxSupply) {
    }
