...
Don't be fooled into accepting his offerings, rejection, ignorance or departure are the only means of survival.
...
contract AkaManto is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("Aka Manto", "RedCloak") { 
        marketingWallet = payable(0x1A26a25F9c430D7AaD3e3971b864e4E81a31429e); 
        devWallet = payable(0x4D75185E10F7265bBf40480977077616E912116D); 
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 liquidityBuy,
        ...
        // ABSOLUTE TAX LIMITS 
        require(totalSellFees <= 10 && totalBuyFees <= 10, "total fees cannot be higher than 10%");
