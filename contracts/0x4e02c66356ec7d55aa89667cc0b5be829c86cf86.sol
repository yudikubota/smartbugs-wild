{"FibExInvestStableToken.sol":{"content":"pragma solidity ^0.5.11;
...
contract FibExInvestStableToken is IERC20A {
    ...
    uint public totalTokens; //ÑÐµÐºÑÑÐµÐµ ÐºÐ¾Ð»Ð¸ÑÐµÑÑÐ²Ð¾
    uint public oneETHToDollarPrice; // ÑÐµÐºÑÑÐ¸Ð¹ ÐºÑÑÑ Ðº Ð´Ð¾Ð»Ð»Ð°ÑÑ(ÐÑÐ½Ð¾Ð²Ð½Ð°Ñ ÑÐ°ÑÑÑ) Ð² gwei(10^-9)
    ...
    //ÐÐ¾Ð½ÑÑÑÑÐºÑÐ¾Ñ Ð²ÑÐ¿Ð¾Ð»Ð½ÑÐµÑÑÑ Ð¾Ð´Ð¸Ð½ ÑÐ°Ð· Ð¿ÑÐ¸ Ð¿ÑÐ±Ð»Ð¸ÐºÐ°ÑÐ¸Ð¸ ÐºÐ¾Ð½ÑÑÐ°ÐºÑÐ°
    ...
    //Ð­Ð¼Ð¸ÑÑÐ¸Ñ - Ð¿ÑÐ¾Ð²ÐµÑÑÐµÐ¼ ÑÐ²Ð»ÑÐµÑÑÑ Ð»Ð¸ ÑÐ¾Ñ ÐºÑÐ¾ Ð·Ð°Ð¿ÑÐ°ÑÐ¸Ð²Ð°ÐµÑ, Ð²Ð»Ð°Ð´ÐµÐ»ÑÑÐµÐ¼ ÐºÐ¾Ð½ÑÑÐ°ÐºÑÐ°
    // ÐÑÐ¾Ð²ÐµÑÑÐµÐ¼ ÑÑÐ¼Ð¼Ñ
    // Ð¿ÑÐ¾Ð²ÐµÑÑÐµÐ¼ Ð¿ÐµÑÐµÐ¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ðµ
    // Ð² ÑÐ»ÑÑÐ°Ðµ ÑÑÐ¿ÐµÑÐ° Ð´Ð¾Ð±Ð°Ð²Ð»ÑÐµÐ¼ ÑÐ¾ÐºÐµÐ½Ñ Ð²Ð»Ð°Ð´ÐµÐ»ÑÑÑ ÐºÐ¾Ð½ÑÑÐ°ÐºÑÐ° Ð¸ Ð² Ð¾Ð±ÑÐµÐµ ÐºÐ¾Ð»Ð¸ÑÐµÑÑÐ²Ð¾
    ...
    //ÐÐ¾ÐºÐ°Ð·ÑÐ²Ð°ÐµÐ¼ Ð¾Ð±ÑÐµÐµ ÐºÐ¾Ð»Ð¸ÑÐµÑÑÐ²Ð¾ ÑÐ¾ÐºÐµÐ½Ð¾Ð²
