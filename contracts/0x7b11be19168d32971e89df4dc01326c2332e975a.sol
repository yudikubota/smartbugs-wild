...
KyÅbu are celestial fox spirits with lush purple fur and full, fluffy tails reminiscent of lavender petals. They are holy creatures, and bring happiness and blessings to those around them.

With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, KyÅbu was designed to reward holders and discourage dumping.
...
contract Kyobu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"KyÅbu";
