...
contract LuckyDegen is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LuckyDegen", "777") {
        ...
        marketingWallet = address(0x8c148BD788247629AB97cb131285Aac052900e7e); // set as marketing wallet
        devWallet = address(0xE716f869c2Fa18588C80d93f8e91999649EdBDEf); // set as dev wallet
