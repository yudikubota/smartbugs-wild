...
contract Islabb is ERC721Enumerable, Ownable {
  ...
  // åå§åç²çï¼ç­å°ä¸å®æ¶æºå¯ä»¥éæºå¼ç®±ï¼åætrue
  bool public _revealed = false;
  // ç²çå¼å³æå¼åï¼éè¦æ¾ç¤ºå¼ç®±çå¾ççbaseå°å
  string public baseURI;
  // ç²çå¾ççmeta,jsonå°åï¼åæä¼æå°
  ...
  uint256 public maxSupply = 9999;
    // é¸é çé±åæå¤åªè½æä¸ä¸ªnftæ°é
