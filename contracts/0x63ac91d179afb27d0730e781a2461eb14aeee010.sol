...
contract NegativeEntropy is Context, AccessControl, ERC721Tradable {
    ...
    */
    ...
    function mint(
        ...
        require(!seedClaimed(seedDesired), "NegativeEntropy: Seed has already been claimedâhow did you make it this far?");
...
32";
    ...
    */ 
    function burn(uint256 tokenId) public {
        ...
        require(seedMap.contains(tokenId), 'NegativeEntropy: Token ID not found in storage â Are you sure it exists?');
        require(seedSet.contains(seedMap.get(tokenId)), 'NegativeEntropy: Token ID not found in storage â Are you sure it exists?');
        _burn(tokenId);
