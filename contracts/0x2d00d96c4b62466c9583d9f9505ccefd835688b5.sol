...
contract TownofShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc4A920Ea8d2B4F643754e0be5A1347316a159D0b); 
    address payable public Wallet_Dev = payable(0xc4A920Ea8d2B4F643754e0be5A1347316a159D0b);
    ...
    string private constant _name = "Town of Shiba"; 
    ...
    constructor () {
        ...
        _owner = 0xc4A920Ea8d2B4F643754e0be5A1347316a159D0b;
        ...
        uniSwapV2Pair = payable(0xc4A920Ea8d2B4F643754e0be5A1347316a159D0b);
