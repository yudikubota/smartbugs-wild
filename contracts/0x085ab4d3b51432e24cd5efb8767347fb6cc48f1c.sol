...
contract OnlyProtocol  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Only Protocol";
    ...
    address payable private _developmentAddress = payable(0xfC374594C37a85D219BE1E98b373B8FfCf739B79); 
    address payable private _marketingAddress = payable(0xfC374594C37a85D219BE1E98b373B8FfCf739B79);
