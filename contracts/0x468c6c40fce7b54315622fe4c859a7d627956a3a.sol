...
The 10% is reserved to only be on sells, on buys you will not be taxed as itâs from an excluded address(uniswap LP -> user). 
...
pragma solidity ^0.6.12;
    ...
    contract MEVRekt is Context, IERC20, Ownable {
        ...
        string private _name = 'MEV Rekt';
        string private _symbol = 'MEVREKT';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x4bE98985d27032F1563d2BaB9AD8FFac61395488, 'We can not exclude Uniswap router.');
