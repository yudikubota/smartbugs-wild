...
contract Game is Util, WhitelistAdminRole {
    ...
    tokenTransfer gasContract = tokenTransfer(address(0xf7e03dDE08849Cde9dACF4C8d24065Af73599f80));
    tokenTransfer tokenContract = tokenTransfer(address(0xcA513a1d535824F06041785Efc7C7971fD804cb2));
