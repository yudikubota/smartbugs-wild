...
contract FIREBALLFINAL is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("FIREBALL", "FIREBALL") { // 
        marketingWallet = payable(0x9997D407F868753d0f4de0300494450207DA06Ad); // 
        devWallet = payable(0xAD396622176eD4342F7E7E3B2eF9F1a337E971EF); // 
