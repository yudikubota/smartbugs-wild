...
/*
 * The Active Pool holds the ETH collateral and RUBC debt (but not RUBC tokens) for all active troves.
 *
 * When a trove is liquidated, it's ETH and RUBC debt are transferred from the Active Pool, to either the
...
contract ActivePool is Ownable, CheckContract, IActivePool {
    ...
    */
    ...
    function increaseRUBCDebt(uint _amount) external override {
        ...
        ActivePoolRUBCDebtUpdated(RUBCDebt);
    }
