...
//  | |  ' | |  .'.-.  | |  ; '  | |  | |  ' |   ; |  ; |  | |         | |  | |  | |   `.__. |  
//  | `-'  ' '  `-' /  ' `-'   `-' '  | `-'  '   ' `-'  |  | |         | |  | |  | |   ___ | |  
//  | \__.'   `.__.'    '.__.'.__.'   | \__.'    `.__.'_. (___)       (___)(___)(___) (   )' |  
//  | |                               | |                                              ; `-' '  
// (___)                             (___)                                              .__.'   
//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9aaF554DF6c72011d6e7B4Cb66bc8a44Ce710edA];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmZcCeeLMNpiPmqqaA1YpZvaTs17eFjsWgjN6AHLXEZidA/";
...
// File: contracts/PewpArmyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PewpArmyContract is RamppERC721A {
    constructor() RamppERC721A("Pewp Army", "PEWP"){}
}
