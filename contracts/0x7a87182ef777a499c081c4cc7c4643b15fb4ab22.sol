...
contract MaMoMe is Ownable, ERC721A, ERC2981 {
    ...
    string public constant contractDescription = unicode"MaMoMe is Capsule21âs first on-chain Open Edition, minting for 48 hours only and in honor of the OC Marilyns @ Sovpunk Museum exhibition. \\n\\nMaMoMe is a derivative of two earlier Capsule 21 projects: OC Marilyn PFPs and mememe.\\n\\nIn OC Marilyn PFPs, a mirrored CryptoPunk 3725 (representing Marilyn Monroe) was colored with Punk colors in all possible combinations. In MaMoME, the Marilyn is filled in with the seven âsoulboundâ colors derived from the unique hexadecimal Ethereum address of her minter, a technique borrowed from mememe.\\n\\nMaMoMe mints are not soulbound and can be traded, but be assured that when you do you always sell a piece of yourself.";
