...
// "Ã¸rÃ1t$â is the updated version, rewritten for on-chain generative art purposes; which displays a unique combination of varying object shapes, color palettes & distribution, orbit directions & speeds for every mint.
...
contract Orbits is ERC721, Ownable {
    ...
    constructor() ERC721("ORBITSNFT","ORBITS")  {
        ...
        GENERATOR_SCRIPT_CODE[2] = "https://berk.mypinata.cloud/ipfs/QmYxCmfpfu8zqvr1CKcG29pAGGLutTi4Nxju4RaX7Rnc3f"; // Ã¸rÃ1t$ sketch code (IPFS)
        GENERATOR_SCRIPT_CODE[5] = "https://arweave.net/qA_hQ7Q8976FJb7KEg1IZO8GyVJWP1V0xcRJrJs2dWw"; // Ã¸rÃ1t$ sketch code (ARWEAVE)
