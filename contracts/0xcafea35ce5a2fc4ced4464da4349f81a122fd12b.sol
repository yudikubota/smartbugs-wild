  ...
  function calculateNXMForEth(
    ...
    /*
      ...
      To compute the number of tokens issued we can integrate with respect to V the following:
        ...
        get an infinitesimally change in token supply ÎT.
      ...
      For a very small variation in tokens ÎT, we have,  ÎT = ÎV / P(V), to get total T we integrate with respect to V.
      adjustedTokenAmount = â« (dV / AdjustedP(V)) from V0 (currentTotalAssetValue) to V1 (nextTotalAssetValue)
      adjustedTokenAmount = â« ((C * MCReth ^ 3) / V ^ 4 * dV) from V0 to V1
