...
contract BTTSTokenInterface is ERC20Interface {
    ...
    bytes public constant signingPrefix = "Ethereum Signed Message:
32";
    bytes4 public constant signedTransferSig = "u2ê¬";
    bytes4 public constant signedApproveSig = "é¯§¡";
    bytes4 public constant signedTransferFromSig = "4KÌ}";
    bytes4 public constant signedApproveAndCallSig = "ñoS";
