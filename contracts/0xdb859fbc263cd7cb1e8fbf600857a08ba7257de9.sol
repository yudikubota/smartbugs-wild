/**
Stop praising those shitty callers, they uses you as exit liq everytime. Fuck the callers!
*/
...
contract FucktheCallers is Context, IERC20, Ownable {
    ...
    string private _name = "They call and uses you as exit liq";
    string private _symbol = "Fuck The Callers";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1391076D51b6bb7de71Eaa35080cA2bEf869cF08));
        _metawallet = payable(address(0x1391076D51b6bb7de71Eaa35080cA2bEf869cF08));
