...
contract YottaCoin {
    ...
    // åä¸ä¸ªè´¦æ·æ»¡è¶³ä»»æå»ç»æ¡ä»¶åè¢«å»ç»
    mapping (address => bool) frozenAccount; //æ éæå»ç»çè´¦æ·
    mapping (address => uint256) frozenTimestamp; // æéæå»ç»çè´¦æ·

    /**
     * æ¥è¯¢è´¦æ·æ¯å¦å­å¨éå®æ¶é´æ³
     */
