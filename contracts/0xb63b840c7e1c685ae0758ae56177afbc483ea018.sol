{{
  "language": "Solidity",
  "sources": {
    "contracts/token/RewardDistributor.sol": {
...
contract RewardDistributor is AccessControl, Pausable {
        ...
        internal
    {
        ...
        address signer = ECDSA.recover(keccak256(abi.encode(CHAIN_ID, address(this), user, rewards, deadline)), v, r, s);
