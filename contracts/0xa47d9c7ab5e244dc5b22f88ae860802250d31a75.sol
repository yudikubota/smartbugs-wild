...
contract TokenAIR is Owned {
    ...
    event Sell(address indexed sender, uint indexed balance, uint amount);
       ...
       function allowance (address _owner, address _spender) public view returns (uint){       // Ð¿Ð¾ÐºÐ°Ð·ÑÐ²Ð°ÐµÑ ÑÐºÐ¾Ð»ÑÐºÐ¾ Ð¼Ð¾Ð¶Ð½Ð¾ ÑÐ½Ð¸Ð¼Ð°ÑÑ Ð´ÐµÐ½ÑÐ³Ð¸ Ñ Ð°Ð´ÑÐµÑÐ° Ð¾ÑÐ¿ÑÐ°Ð²Ð¸ÑÐµÐ»Ñ
        return allowed [_owner][_spender];
    }
    
     function approve(address _spender, uint _value) public {             // Ð¾ÑÐ¿ÑÐ°Ð²Ð¸ÑÐµÐ»Ñ Ð´Ð°ÐµÐµÑ ÑÐ°Ð·ÑÐµÑÐµÐ½Ð¸Ðµ Ð½Ð° ÑÐ½ÑÑÐ¸Ðµ Ð´ÐµÐ½ÐµÐ³ Ñ Ð°Ð´ÑÐµÑÐ° function transferFrom
