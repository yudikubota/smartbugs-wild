// The GBP and other currencies have fallen to record lows against the U.S. Dollar.
// GBP Inu is the Hedge.
// t.me/GBPInu
// _______  _______  _______    ___   __    _  __   __ 
//|       ||  _    ||       |  |   | |  |  | ||  | |  |
//|    ___|| |_|   ||    _  |  |   | |   |_| ||  | |  |
//|   | __ |       ||   |_| |  |   | |       ||  |_|  |
//|   ||  ||  _   | |    ___|  |   | |  _    ||       |
//|   |_| || |_|   ||   |      |   | | | |   ||       |
//|_______||_______||___|      |___| |_|  |__||_______|
...
contract GBPINU is ERC20, Ownable {
    ...
    constructor() ERC20("GBP Inu", "GINU") {
