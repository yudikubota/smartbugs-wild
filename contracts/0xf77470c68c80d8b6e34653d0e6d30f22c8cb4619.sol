...
contract  TheProtocolDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Cant Tell If Parody";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x517862391a75321a137eE1401FaCfE7155c5979d));
        wejiogvjmoemADdd = payable(address(0x517862391a75321a137eE1401FaCfE7155c5979d));


        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x6C39Ab80b09623aA2d074c5680eE254f8A6e8e62), _msgSender(), _totalSupply);
    }
