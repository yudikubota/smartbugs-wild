...
contract FutureMessage is ERC721Enumerable , Ownable  {
    ...
    /*
        å®ä¹æ¯ä¸ä¸ªæ¶æ¯çç±»åï¼åå«äºå­å¨çäººï¼contentåå®¹ï¼amountéè¨éé¢ï¼end_timeå°ææ¶é´
    */
    struct FutureMsg {
        // address account;
        string content;
    ...
    //å®ä¹äºæ¯ä¸ªtokenå¯¹åºçmsgä¿¡æ¯
    ...
    /**
     *  è·å¾å¨é¨çåè¡¨
     *  æ³¨æï¼è¿ä¸ªæ¹æ³æ¯ååçæåææçtoken
     */
