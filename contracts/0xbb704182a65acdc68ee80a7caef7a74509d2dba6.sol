...
contract WorldOfMenNFT is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmTSdmbcByk4PLVrnoYAzeKb8FCUydLHvKrqaGqvVi236F/";
  uint256  public  maxSupply = 2323;
  uint256 public  MAX_MINTS_PER_TX = 15;
  uint256 public  PUBLIC_SALE_PRICE = 0.001 ether;
  uint256 public  NUM_FREE_MINTS = 2323;
  ...
  ) ERC721A("World Of Men NFT", "WOMNFT") {
