...
contract Kleros is Arbitrator, ApproveAndCallFallBack {
    ...
    uint public alpha = 2000; // alpha in â± (1 / 10 000).
    uint constant ALPHA_DIVISOR = 1e4; // Amount we need to divided alpha in â± to get the float value of alpha.
