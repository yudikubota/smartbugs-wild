/*
 ...
 TG:- https://t.me/MyExGirlFrien  
 
 WebSite:-  http://myexgirlfriend.co/


 -----  Time to show your ex who's the baller --------
...
contract MyExGirlfriend  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("My Ex Girlfriend", "MEG") {
    	...
    	dev1Wallet = payable(0x8fd4AF765A8F1Da00D5dAA675Bc5251a5A58Af91);  // set as dev1 wallet
        dev2Wallet = payable(0x8fd4AF765A8F1Da00D5dAA675Bc5251a5A58Af91);  // set as dev2 wallet
        dev3Wallet = payable(0x8fd4AF765A8F1Da00D5dAA675Bc5251a5A58Af91);  // set as dev3 wallet
        dev4Wallet = payable(0x8fd4AF765A8F1Da00D5dAA675Bc5251a5A58Af91);  // set as dev4 wallet
        dev5Wallet = payable(0x8fd4AF765A8F1Da00D5dAA675Bc5251a5A58Af91);  // set as dev5 wallet

        marketingWallet = payable(0x8fd4AF765A8F1Da00D5dAA675Bc5251a5A58Af91); //marketing wallet
