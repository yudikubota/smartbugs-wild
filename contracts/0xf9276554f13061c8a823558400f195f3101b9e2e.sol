...
MyÅbu are celestial fox spirits with white fur and full, fluffy tails reminiscent of ripe grain. They are holy creatures, and bring happiness and blessings to those around them.
With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, MyÅbu was designed to reward holders and discourage dumping.
...
contract Myobu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WTF MyÅbu";
