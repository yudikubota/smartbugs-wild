...
There are many zero-tax carpets in the market. They do not lock the wallets that often deceive investment. This will be an agreement made by investors to create a good transaction for Ethereum. The lock is the moon

we're locked and renonced

Twitter:https://twitter.com/MoonLock_ETH
Telegram:https://t.me/MoonLock_Protocol
...
contract MoonLockProtocol is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"MoonLockÂ Protocol";
    string private constant _symbol = unicode"MLP";
