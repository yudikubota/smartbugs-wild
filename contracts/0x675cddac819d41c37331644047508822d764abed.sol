{{
  "language": "Solidity",
  "sources": {
    "contracts/core/KomorebiNoSekai.sol": {
      "content": "// SPDX-License-Identifier: Apache-2.0
// äººé¡ã®åæã¯ããããã ã
...
contract KomorebiNoSekai is Ownable, ERC721A, ReentrancyGuard, VRFConsumerBase {
    ...
    // Furaribi (ãµããç«, Furaribi) are the ghost of those murdered
    ...
    // ãã¤ã Naito (from english: "Knight")
    // ã©ã¤ã Raito (from english: "Light")
