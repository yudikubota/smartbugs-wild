...
contract BabyAbrahamLincoln is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Abraham Lincoln";////////////////
    ...
    address payable private _developmentAddress = payable(0xC4Ca344EBDbA013A23b08955977d6fA0fF91A339);////////////////////
    address payable private _marketingAddress = payable(0xC4Ca344EBDbA013A23b08955977d6fA0fF91A339);/////////////////////
