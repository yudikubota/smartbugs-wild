...
contract Fund {
    ...
    constructor() public {
        ...
        percentages[0x56955CF0778F5DD5a2E79Ff9e51b208dF11Ef380] = 1000;  // ÐÐ¾ÑÐµÐ»ÐµÐº B 10%
        percentages[0x75f44Ab0FDf7bBEdaDa482689c9847f06A4Be444] = 500;   // ÐÐ¾ÑÐµÐ»ÐµÐº Ð 5%
...
contract BlagaDaru {
    ...
    constructor() public {
        ...
        blago = address(0x56955CF0778F5DD5a2E79Ff9e51b208dF11Ef380);        // ÐÐ¾ÑÐµÐ»ÐµÐº B 10%
        walletK = address(0x75f44Ab0FDf7bBEdaDa482689c9847f06A4Be444);      // ÐÐ¾ÑÐµÐ»ÐµÐº Ð 5%
        ...
        list[44] = 0x56955CF0778F5DD5a2E79Ff9e51b208dF11Ef380;   // ÐÐ¾ÑÐµÐ»ÐµÐº B 10%
        list[45] = 0x75f44Ab0FDf7bBEdaDa482689c9847f06A4Be444;   // ÐÐ¾ÑÐµÐ»ÐµÐº Ð 5%
