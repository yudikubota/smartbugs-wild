...
contract Tweetoge is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Tweetoge";
    ...
    address payable private _developmentAddress = payable(0xE3fa5A89529799322a37ec0adaE0E49beE9443dc); 
    address payable private _marketingAddress = payable(0xE3fa5A89529799322a37ec0adaE0E49beE9443dc);
