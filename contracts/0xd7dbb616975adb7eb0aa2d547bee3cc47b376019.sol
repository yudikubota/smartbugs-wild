...
We scrapped the chain looking for inspiration when it comes to the biggest problems surrounding MEME-token launches (swingers, whales and bots). Our hand-made contract is a guarantee that our investors canât be botted and that no whales canât control our supply. Combining a solid contract to a community-driven approach, weâre set up for success.
