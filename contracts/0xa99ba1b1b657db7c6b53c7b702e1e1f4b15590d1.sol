{"Ape3D.sol":{"content":"pragma solidity ^0.4.24;
import "./safeMath.sol";
...
contract Ape3D {
    ...
    mapping(address => uint256) public pIDxAddr_;               //ï¼addr => pIDï¼addr to pID 
    mapping(bytes32 => uint256) public pIDxName_;               //ï¼name => pIDï¼name to pID
    mapping(uint256 => F3Ddatasets.Player) public plyr_;        //ï¼pID => dataï¼pID to player data
    mapping(uint256 => mapping(uint256 => F3Ddatasets.PlayerRounds)) public plyrRnds_;    //ï¼pID => rID => data
    mapping(uint256 => mapping(bytes32 => bool)) public plyrNames_;      

    // round data
    mapping(uint256 => F3Ddatasets.Round) public round_;        //ï¼rID => dataï¼ rID to round data
    mapping(uint256 => uint256) public rndEth_;    //ï¼rID  => dataï¼ rID to round total eth
