...
contract YFI2 {
    string public name = 'yearn.finance2';
    string public symbol = 'YFI1';
    ...
    uint256 subscription=50000 ether;//è®¤è´­5ä¸å¸
    uint256 mine_out=40000 ether;//æç¿4ä¸å¸
    ...
    function input_mine(uint256 value)public{
        ...
        require(mine_out >=m);
        if(m>0){//å¤ææ¶åååºä¹åæç¿çæ¶ç
            mine_out-=m;
