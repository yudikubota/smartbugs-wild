{{
  ...
  "sources": {
    "contracts/GenerativeCollection.sol": {
      "content": "// contracts/GenerativeCollection.sol
  ...
  Ownable
{
  ...
  constructor() ERC721('Free Rangers', 'RANGER') {
    _metadataBaseURI = 'https://moonwalk.mypinata.cloud/ipfs/QmY3cvppdpxmdAksgS8j5yUk4iyixhhH3HcMHJzLKW3PND/';
