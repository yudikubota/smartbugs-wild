...
contract VRF {
  ...
  // Let q=FIELD_SIZE. q % 4 = 3, â´ xâ¡r^2 mod q â x^SQRT_POWERâ¡Â±r mod q.  See
  ...
  // Returns x1/z1-x2/z2=(x1z2-x2z1)/(z1z2) in projective coordinates on PÂ¹(?â)
  ...
  // Returns x1/z1*x2/z2=(x1x2)/(z1z2), in projective coordinates on PÂ¹(?â)
...
/*
  ...
  â â â â ââââââââââââââ day of the week (0 - 6) (Monday to Sunday)
  â â â â â
  â â â â â
  â â â â â
  * * * * *
