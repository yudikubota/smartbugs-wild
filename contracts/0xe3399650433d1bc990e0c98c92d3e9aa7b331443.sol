    ...
    FundsMgr
{
    ...
    struct Strategy {
        ...
        uint80 deposit;  // in eth â max more 1.2 mln eth
        uint80 entryEthPrice;  // in usd â max more 1.2 mln USD for 1 eth
        uint8 profitPercent;  // % â 0 to 255
        uint8 fee;  // % â 0 to 100 (ex. 30% = 30)
        uint80 ethForRedeem;  // eth for repay loan â max more 1.2 mln eth
        ...
        onlyOwnerOrAdmin
    {
        ...
        /**
            exResult[2] - extra ToTokens after exchange â USDC
            exResult[3] - extra FromTokens after exchange â ETH
         */
    ...
    function _increaseStrategyUsd(
        ...
        /**
            exResult[2] - extra ToTokens after exchange â ETH
            exResult[3] - extra FromTokens after exchange â USDC
         */
