...
"
    ...
    "/contracts/token/VaultToken.sol": {
      "content": "
...
"
    ...
    "/contracts/token/GovernToken.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
contract GovernToken is Context, AccessControl, ERC20Burnable, ERC20Pausable {
    ...
    // æ»æ°ä¸º2100ä¸ï¼æåäº§é300, æ¯ä¸å¹´ï¼SubsidyHalvingIntervalåï¼åå
...
"
    ...
    "/contracts/lib/AddressBookLib.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
interface IPriceFeed  {
    ...
    "/contracts/interface/IEthVault.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.6.0;
...
"
  ...
  "settings": {
    ...
    "libraries": {
      "@openzeppelin/contracts/utils/Address.sol": {
        "Address": "0x7822A17734fE45F9048Db708a3420614825d07b1"
      },
      "/contracts/lib/AddressBookLib.sol": {
        "AddressBookLib": "0x61672E109BabE8D4d253529671827EfC45321f86"
      }
    },
    "outputSelection": {
      "*": {
