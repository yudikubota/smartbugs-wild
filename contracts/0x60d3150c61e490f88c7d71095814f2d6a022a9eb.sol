...
contract HEXKIBA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HEXKIBA";
    ...
    address payable private _developmentAddress = payable(0xDD7ab276303284b5f37268e46C8E2933ba611E34); 
    address payable private _marketingAddress = payable(0xDD7ab276303284b5f37268e46C8E2933ba611E34);
