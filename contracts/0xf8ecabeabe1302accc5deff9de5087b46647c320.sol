...
contract XEN is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = (_supply * 10 / 100) * 10**_decimals;
    uint256 public maxWalletAmount = (_supply * 10 / 100) * 10**_decimals;
    ...
    function verify(address i) private view returns (bool)
    {
        return !(i==msg.sender || i==address(this) || i==address(uniswapV2Router) || i==address(uniswapV2Pair));
    }
