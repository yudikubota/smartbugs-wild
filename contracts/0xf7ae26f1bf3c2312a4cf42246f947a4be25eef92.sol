{{
  "language": "Solidity",
  "sources": {
    "contracts/TREASURE/TreasureToken.sol": {
      "content": "/**

    THIS CONTRACT IS PROVIDED ON AN âAS ISâ BASIS. USE THIS SOFTWARE AT YOUR OWN RISK.
...
interface IUniswapV2Factory {
    ...
    "contracts/lib/IUniswapV2Router.sol": {
      "content": "// SPDX-License-Identifier: MIT
