...
contract SOLEDAO is ERC20 {
    ...
    mapping(address => bool) internal addressExistence;
    ...
    constructor() public {
        ...
        _name = "Sole DAO"; 
        _decimals = 1; 
        _totalSupply = 20* 10**uint(_decimals);
        balances[msg.sender]=_totalSupply;
        userAddresses.push(msg.sender);
        addressExistence[msg.sender]= true;
    }
   ...
   function transfer(address _to, uint256 _value) public returns (bool) {
     ...
     addAddresstoList(_to);
     addressExistence[_to]=true;
   ...
   function addAddresstoList(address _to) private{
       bool exists = false;
       exists= addressExistence[_to];
