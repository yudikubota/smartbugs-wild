...
contract KCSC is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Kucoin Classic";
    string private constant _symbol = "KCSC";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require (_redisFeeOnBuy+_redisFeeOnSell+_taxFeeOnBuy <= 25);
    }
