// UNIVERSAL USDC PRINTER is the new Reflection token on ETH network !
// By holding UUP, you will see your USDC reward rising on each TX.
// You just need to sell a little part of token to receive your USDC reward
// The more you have and the more you hold, the more rewards you will receive 

//Telegram : https://t.me/+SvadDGeCHJ8zNDdk

//Fees : 4% reflection on USDC
//       1% on liquidity
//       3% on marketing wallet
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); // reward address USDC
...
contract Printer is IBEP20, Auth {
    ...
    address EP = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; // reward USDC
    address public WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Universal USDC Printer";
    string constant _symbol = "UUP";
    ...
    address public autoLiquidityReceiver=0x4a2F061264891470174219D02c18325A5DdDB933; //liq address
    address public marketingFeeReceiver=0x4a2F061264891470174219D02c18325A5DdDB933; // marketing address
    ...
    constructor () Auth(msg.sender) {
        ...
        isTxLimitExempt[0x4a2F061264891470174219D02c18325A5DdDB933] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        buyBacker[msg.sender] = true;
        isMaxWalletExempt[0x4a2F061264891470174219D02c18325A5DdDB933] = true;
