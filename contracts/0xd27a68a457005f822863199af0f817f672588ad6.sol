...
library LibTreasury
{
    ...
    enum STATUS {
        NONE,              //
        RESERVEDEPOSITOR,  // í¸ëì ë¦¬ì ìì¹í ììë ê¶í
        RESERVESPENDER,    // í¸ëì ë¦¬ìì ìì° ì¬ì©í  ì ìë ê¶í
        RESERVETOKEN,      // í¸ëì ë¦¬ìì ì¬ì©ê°ë¥í í í°
        RESERVEMANAGER,     // í¸ëì ë¦¬ ì´ëë¯¼ ê¶í
        LIQUIDITYDEPOSITOR, // í¸ëì ë¦¬ì ì ëì± ê¶í
        LIQUIDITYTOKEN,     // í¸ëì ë¦¬ì ì ëì± í í°ì¼ë¡ ì¬ì©í  ì ìë í í°
        LIQUIDITYMANAGER,   // í¸ëì ë¦¬ì ì ëì± ì ê³µ ê°ë¥ì
        REWARDMANAGER,       // í¸ëì ë¦¬ì ë¯¼í¸ ì¬ì© ê¶í.
        BONDER,              // ë³¸ë
        STAKER                  // ì¤íì´ì»¤
    }

    // ë¯¼í¸ë ììì ìê¸(í ì¤ íê°ê¸)ë¹¼ê³ ,
    // ëë¨¸ì§ìì ê¸°ê´ì ë¶ë°° ì ë³´ (ê¸°ê´ì£¼ì, ë¨ëê¸ì¡ìì í¼ì¼í¸)ì êµ¬ì¡°ì²´
    struct Minting {
        address mintAddress;
