...
contract Burn is ERC20Detailed {
  ...
  string constant tokenName = "BurnIt";
  string constant tokenSymbol = "BURN";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 800000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x1516AE9916f9E238e548ea432721e55457764768] = _balances[0x1516AE9916f9E238e548ea432721e55457764768].add(tokensForRewards);
    ...
    emit Transfer(msg.sender, 0x1516AE9916f9E238e548ea432721e55457764768, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0x1516AE9916f9E238e548ea432721e55457764768, tokensForRewards);
