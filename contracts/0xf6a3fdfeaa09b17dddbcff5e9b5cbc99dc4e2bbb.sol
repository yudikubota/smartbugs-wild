...
/*
âI love NFT Twitter because itâs half 20-tweet threads about how blockchains will
 be the Medicis of a new artistic renaissance and half guys trying to convince you
 to spend $10,000 on stuff called, like, Darrylâs Deformed Donkeys.â 
â Technology writer and New York Times columnist Kevin Roose, 28/09/2021
...
contract DeformedDonkeys is ERC721, Ownable {
    ...
    function getPrefixedHash(bytes32 messageHash) internal pure returns (bytes32) {
        bytes memory hashPrefix = "Ethereum Signed Message:
32";
