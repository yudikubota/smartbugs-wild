...
https://www.infiniteprotocol.live/
https://t.me/infiniteprotocolv2
...
contract Inft2F is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("infiniteprotocol2", "IFT2") { // 
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= _totalSupply / 100, "%");
        maxWallet = value;
    }
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 burnBuy,
        ...
        // 
        require(totalSellFees <= 30 && totalBuyFees <= 15, "t");
