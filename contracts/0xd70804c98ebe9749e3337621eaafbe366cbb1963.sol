...
/**
 * @title Bitcoin_Stable
 * @dev Token representing Bitcoin_Stable.
 */
contract Bitcoin_Stable is BurnableToken {
  ...
  */
  constructor(address wallet) public {
    owner = wallet;
    totalSupply = uint(1000000000000).mul(10 ** uint256(decimals)); //Update total supply with the decimal amount
    name = "Bitcoin Stable";
    symbol = "BTST";
