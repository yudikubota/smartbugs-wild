...
contract TokenStaking is Authorizations, StakeDelegatable {
    ...
    /// The staking contract guarantees that an undelegated operatorâs stakes
    ...
    /// amount or adds the approved amount to an existing delegation (a âtop-upâ).
...
"
    ...
    "solidity/contracts/TokenStakingEscrow.sol": {
      "content": "/**
âââ ââ âââ ââââââââââââââââââââââââââââââ ââââââââââââââââââ ââââââââââââââââââ
ââââââââââ ââââââââââââââââââââââââââââââ ââââââââââââââââââ âââââââââââââââââââ
  ââââââ    ââââââââ    âââââââ    ââââââ   ââââââ     âââââ   âââââââ   âââââââ
...
contract TokenStakingEscrow is Ownable {
    ...
    "solidity/contracts/TokenSender.sol": {
      "content": "pragma solidity 0.5.17;
...
"
    ...
    "solidity/contracts/GasPriceOracle.sol": {
      "content": "/**
âââ ââ âââ ââââââââââââââââââââââââââââââ ââââââââââââââââââ ââââââââââââââââââ
ââââââââââ ââââââââââââââââââââââââââââââ ââââââââââââââââââ âââââââââââââââââââ
  ââââââ    ââââââââ    âââââââ    ââââââ   ââââââ     âââââ   âââââââ   âââââââ
...
contract GasPriceOracle is Ownable {
    ...
    "solidity/contracts/libraries/RolesLookup.sol": {
      "content": "pragma solidity 0.5.17;
...
"
    ...
    "solidity/contracts/libraries/staking/MinimumStakeSchedule.sol": {
      "content": "pragma solidity 0.5.17;
...
"
    ...
    "solidity/contracts/libraries/staking/GrantStaking.sol": {
      "content": "pragma solidity 0.5.17;
...
"
    ...
    "solidity/contracts/libraries/staking/TopUps.sol": {
      "content": "pragma solidity 0.5.17;
