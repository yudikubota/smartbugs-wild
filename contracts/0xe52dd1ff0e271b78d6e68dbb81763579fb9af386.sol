...
contract PEPEREUM is Context, IERC20, Ownable {
    ...
    uint256 public _maxWallet = 2 * 990000000000000000000 * 10 ** 9;
    ...
    function upliftTxAmount() external onlyOwner() {
        ...
        _maxWallet = 69000000000000000000000 * 10 ** 9;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        if (!canTrade) {
            ...
            // only owner allowed to trade or add liquidity
        } else {
