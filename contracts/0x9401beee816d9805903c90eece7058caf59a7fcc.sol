{{
  "language": "Solidity",
  "sources": {
    "/contracts/FancyTraitV2Sale.sol": {
...
"
    ...
    "/contracts/interfaces/ILevels.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
abstract contract ILevels {
    ...
    "/contracts/interfaces/IHoneyVesting.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
abstract contract IHoneyVesting {
    ...
    "/contracts/interfaces/IHoneyToken.sol": {
      "content": "// SPDX-License-Identifier: MIT
...
abstract contract IHoneyToken is IERC20 {}"
    ...
    "/contracts/interfaces/IHoneyJars.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.12;
...
interface IHoneyJars is IERC721, IERC721Enumerable {
    ...
    "/contracts/interfaces/IHive.sol": {
...
interface IHive {
    ...
    "/contracts/interfaces/IFancyTraitsV2.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
abstract contract IFancyTraitsV2 is IERC1155 {
    ...
    "/contracts/interfaces/IFancyBears.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.12;
...
interface IFancyBears is IERC721, IERC721Enumerable {
    ...
    "/contracts/interfaces/IFancyBearStaking.sol": {
      "content": "// SPDX-License-Identifier: MIT
pragma solidity ^0.8.14;
...
abstract contract IFancyBearStaking {
    ...
    "/contracts/interfaces/IFancy721.sol": {
      "content": "// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.12;
