...
In Japan, the rabbit is described as holding a mallet, which he uses to pound mochi (rice cake).
The mallet and mortar are also visible like black spots on the moon.
rabbits are thought not to be making mochi, but mixing the medicine for immortality.

ð°TG:https://t.me/Gyokuto_ETH
...
contract GyokutoInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Gyokuto Inu";
    string private constant _symbol = unicode"çåð°";
