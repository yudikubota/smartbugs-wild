...
contract DoodBirds is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("DoodBirds", "DB") {
    setHiddenMetadataUri("ipfs://QmUhwpaCsuKqcWtQ9iZdfHeHuSR5rn8swwd8VGNc8hS7Cn/hidden.json");
  }
