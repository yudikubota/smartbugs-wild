...
library FullMath {
    /// @notice Calculates floor(aâÃ¹bââdenominator) with full precision. Throws if result overflows a uint256 or denominator == 0
    ...
    /// @notice Calculates ceil(aâÃ¹bââdenominator) with full precision. Throws if result overflows a uint256 or denominator == 0
    /// @param a The multiplicand
    /// @param b The multiplier
    /// @param denominator The divisor
    /// @return result The 256-bit result
