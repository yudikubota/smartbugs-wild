...
* BigBrainCoin
*
* https://shutr.bz/3dwpXS1
* 
* A small premine pyramid shitclone, enter at your own risk, many people have made money on these things, many people have lost money as well. Good luck to everyone. 
*
* -> What?
* Incorporated the strong points of different POW{x}, best config:
* [â] 10% dividends for token purchase, shared among all token holders.
* [â] 10% dividends for token transfer, shared among all token holders.
* [â] 15% dividends for token selling.
* [â] 7% dividends is given to referrer.
* [â] 50 tokens to activate Masternodes.
*
*/

contract BigBrainCoin {
    ...
    string public name = "BigBrainCoin";
