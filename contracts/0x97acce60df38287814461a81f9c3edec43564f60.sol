...
contract DragonDomain is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Dragon Domain";
string constant tokenSymbol = "DDIN";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 5500000000000000000000;
