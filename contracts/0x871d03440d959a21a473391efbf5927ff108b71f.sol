...
Total tax - 4/6%
World is in 47 trillion dollars debt
Countries are printing paper currencies non stop
Inflation is at its peek
UK's economy is collapsing
Its all getting fucked

So, World Debt Inu makes sense
A currency which will rise as the world falls
...
contract WorldDebtInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "World Debt Inu";////////////////
    ...
    address payable private _developmentAddress = payable(0xF4879Cf6D0e5AbFF206f30Dd864719a8fF3491a6);////////////////////
    address payable private _marketingAddress = payable(0xF4879Cf6D0e5AbFF206f30Dd864719a8fF3491a6);/////////////////////
