...
contract StonedDucks is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI = "ipfs://QmVANKDXbZNDura7o65YUUGFM4cNpz95oSNh3zSR3skr7p/";
  uint public          price             = 0.0035 ether;
  uint public          maxPerTx          = 10;
  uint public          maxFreePerWallet  = 3;
  uint public          totalFree         = 1959;
  uint public          maxSupply         = 5500;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

    constructor() ERC721A("Stoned Ducks", "STONEDDUCKS"){}
