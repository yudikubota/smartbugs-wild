{{
  "language": "Solidity",
  "sources": {
    "contracts/PixelProxy.sol": {
      "content": "pragma solidity ^0.6.0;

contract PixelProxy {
  bytes32 private constant implementationPosition = bytes32(uint256(keccak256("pixel.proxy.implementation")) - 1);
  bytes32 private constant proxyOwnerPosition = bytes32(uint256(keccak256("pixel.proxy.owner")) - 1);
