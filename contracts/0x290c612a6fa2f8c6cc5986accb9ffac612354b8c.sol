...
I HAVE RETURNED, DO NOT FADE MY OFFERING
...
contract FLYOSHI is IERC20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'FLYOSHI';
    string private constant _symbol = 'FLYOSHI';
    ...
    function clearbalance() public authorized {
        ...
        payable(marketing).transfer(amountETH);
    }
