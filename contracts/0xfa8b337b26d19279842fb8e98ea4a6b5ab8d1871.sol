...
contract unpNft is ITRC721, ITRC165, ITRC721Metadata, ITRC721Enumerable {
    using EnumerableSet for EnumerableSet.UintSet;
    // using EnumerableSetMarket for EnumerableSetMarket.MarketLotSet;
    string oneURL = "https://arweave.net/9pFl9AQUBMEb9rJFef053WkdKRtymgEwOpLZ-sSz1VE";
    // string twoURL = "https://arweave.net/_Dl40ONVeHT3QT74-hrjFZOuP7S_QLSFhMZh3-_JoFs";
    // string threeURL = "https://arweave.net/zXo3YwW5mxvVNqGWL7O231q2wxP9VxV1qL0ddJxZXH8";
    string internal _name = "UNP";
    string internal _symbol = "Ur New PFP";
    // IERC20 public USDT = IERC20(0xa65A31851d4bfe08E3a7B50bCA073bF27A4af441);
    uint256 internal totalMinted = 0;
    uint256 internal totalMigrated = 0;
    // uint public num_88;
    // uint public num_288;
    // uint public num_388;
    uint256 public constant MINTING_LIMIT = 5000;
    ...
    constructor() {
        ...
        admin = msg.sender;
        contractOwner = msg.sender;   // TODO Ð¿ÑÐ¾Ð²ÐµÑÐ¸ÑÑ, ÑÑÐ¾ Ð¾Ð¿Ð»Ð°ÑÐ° Ð¿ÑÐ¾ÑÐ¾Ð´Ð¸Ñ
    }
    ...
    //     // address[] memory adaArr = team1[addr];
    //     return  team1[addr];
    // }
    ...
    // function getTeamLen(address addr)public view returns(uint[2] memory arr){
    //     arr = [team1[addr].length,team2[addr].length];
    // }
    ...
    function totalSupply() public view override returns(uint256) {
        return (totalMinted + totalMigrated+sum_tokenId);
    }
    ...
    function mint() external  payable {
        require(msg.value>0.00099 ether,"0.001");
        require(sum_tokenId<5001,"8000");
     
        _addToken(msg.sender, sum_tokenId);
        URI[sum_tokenId] = oneURL;
    ...
    function recoverEth() external isAdmin{
