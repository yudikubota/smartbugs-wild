...
contract USDInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "USD Inu";
    string private constant _symbol = "USDINU";
    ...
    address payable public marketingWallet = payable(0x95e9B723b99d0b01D19176b72C0abCd98207F9d3);
    address payable public treasury = payable(0x95e9B723b99d0b01D19176b72C0abCd98207F9d3);
