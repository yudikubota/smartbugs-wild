 ...
 *             â âââ¤ ââ¤ ââ  ââââ¤â   â KOL Community Foundationâ â âââââ¤ ââ´âââââ â ââ¤
 *             ââââ  â  â´ââââ´â´ â´â´ââ âââ¬ââââââââââââââââââââââ¬ââ ââ©âââââââââââ´ â´ âââ
 *   ââââââââââââââââââââââââââââââââââ                     ââââââââââââââââââââââââââââââââ
 *   â    âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ  â
 *   ââââââ¤ Dev:Jack Koe âââââââââââââââ¤ Special for: KOL  âââââââââââââââââ¤ 20200513   ââââ
...
contract KOLPro is Ownable{
  ...
  /**
   * title è½¬å¥KOLè¿è¡æä»çæ¯
   * _usdtOrCoin, true:éæ¬ä½; false:å¸æ¬ä½
   * dev visit: https://github.com/jackoelv/KOL/
  */
  function join(uint256 _amount,bool _usdtOrCoin) payable  public {
    ...
    uint256 amount3;//amount*3/1000ä»¥å
      ...
      minAmount = _amount;
        ...
        if(LockHistory[_selfAddr].length > 1){
            ...
            if (topDayLockBalance > previousLockBalance){
              //_amount + previousLockBalance ä¸å®æ¯å¤§äºtopDayLockBalanceçï¼
  ...
  function setTopTeamBonus(address _topAddr,uint256 _minAmount) private {
    ...
    if (LockTeamBonus[_topAddr].length == 0){
      ...
      theDayTB.totalTeamBonus = lastingDays * theDayTB.theDayTeamBonus * theDayTB.theDayRate/100;//è¿éä¸å¥½è§£å³å
      theDayTB.totalTeamBonus += _minAmount * newRate / 100;
      theDayTB.theDayTeamBonus += _minAmount;
      theDayTB.theDayRate = newRate;
        //å¿ç¶å°±é½æ¯æå¤©ã
  ...
  /**
   * title æ¥è¯¢å¹¶è®¾ç½®ç¨æ·çèº«ä»½çº§å«
   * dev visit: https://github.com/jackoelv/KOL/
  */
  ...
  /**
   * title æ¥è¯¢æå®æ¶é´ç¨æ·çææéä»ä½é¢
   * dev visit: https://github.com/jackoelv/KOL/
  */
  function queryLockBalance(address _addr,uint256 _queryTime) public view returns(uint256) {
    ...
    for (uint j = 0; j<LockHistory[_addr].length; j++){
      if (LockHistory[_addr][j].withDrawed){
        //å¦ææ¯å·²ç»æç°çèµéï¼é£å°±è¦æ±è®¡ç®æ¥ææ¯å¨èµ·æ­¢æ¶é´åçã
  ...
  /**
   * title æ ¹æ®ç»å®æ¶é´è®¡ç®åºæ¨å¤©çæåä¸ç§
   * dev visit: https://github.com/jackoelv/KOL/
  */
